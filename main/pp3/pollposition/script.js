    ...
    <div id="game" class="game pt-pageholder pollposition-background">
		<div class="pt-page-off state-lobby pollposition-page">
			<div class="container">
				...
				<form class="pure-form">
					<button type="button" id="pollposition-startgame" class="pollposition-button button-xlarge pure-button pure-input-1"><span>estamos todos</span></button>
					<button type="button" id="pollposition-stopcountdown" class="pollposition-button button-xlarge pure-button pure-input-1"><span>cancelar</span></button>
				</form>
			</div>
		</div>
		...
		<div class="pt-page-off state-post-lobby pollposition-page">
			<div class="container">
				...
				<form class="pure-form">
					<button type="button" id="pollposition-sameplayers" class="pollposition-button button-xlarge pure-button pure-input-1 pollposition-endbuttons"><span>mismos jugadores</span></button>
					<button type="button" id="pollposition-newplayers" class="pollposition-button button-xlarge pure-button pure-input-1 pollposition-endbuttons"><span>nuevos jugadores</span></button>
				</form>
        ...
        <div class="pt-page-off state-upordown-sent pollposition-page">
            <div class="container">
                ...
                <p class='pollposition-text'>gracias por tu selección</p>
            </div>
        </div>
        ...
        <div class="pt-page-off state-waitforaudience pollposition-page">
            <div class="container">
                <p class='pollposition-text'>Gracias por tu aporte.<br/>Esperando al público.</p>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="pollposition-range-buffer"> 
                    <form class="pure-form" id="pollposition-enterpercentage-field"> 
                        <div class=""> 
                            <button type="submit" id="pollposition-submitpercentage" class="pollposition-button"><span>Enviar</span></button> 
        ...
        <div class="pt-page-off state-upordowndone pollposition-page">
            <div class="container">
                <p class='pollposition-text'>¡hecho!</p>
            </div>
        </div>
        ...
        <div class="pt-page-off state-choosecharacter pollposition-page">
            <div class="container" align="center">
                ...
                <form class="pure-form">
                    <button type="button" id="pollposition-character-startgame" class="pollposition-button button-xlarge pure-button pure-input-1"><span>estamos todos</span></button>
                    <button type="button" id="pollposition-character-stopcountdown" class="pollposition-button button-xlarge pure-button pure-input-1"><span>cancelar</span></button>
                </form>
...
const Gx = lc.extend({
    ...
    updatePlayer() {
        ...
        if (i && i === "Lobby") {
            ...
            if (n === "Lobby_ChooseCharacter") {
                this.hideCharacterLobbyButtons(), ae("#pollposition-choosecharacter-text").html("Selecciona a tu agente");
                let v = "";
                ...
                ae("#pollposition-choosecharacter").html(v), this.showScreen(".state-choosecharacter"), t.isAllowedToStartGame && (f === "CanStart" ? (ae("#pollposition-characterlobby-text").html("pulsa este botón cuando todos se hayan unido"), ae("#pollposition-character-startgame").show()) : f === "Countdown" && (ae("#pollposition-characterlobby-text").html("pulsa este botón para cancelar el inicio de la partida"), ae("#pollposition-character-stopcountdown").show())), this.onResize();
                return
            }
            if (f === "PostGame") {
                t.isAllowedToStartGame ? (ae("#pollposition-post-lobby-text").html("¿qué quieres hacer?"), ae(".pollposition-endbuttons").show()) : ae("#pollposition-post-lobby-text").html("¡Siéntate y relájate!");
                let v = '<table class="table table-striped table-bordered"><thead><tr><th>Posición</th><th>Jugador</th><th>Puntaje</th></tr></thead><tbody>';
            ...
            if (!t.isAllowedToStartGame) {
                ae("#pollposition-lobby-text").html("¡Siéntate y relájate!"), this.showScreen(".state-lobby");
                return
            }
            f === "WaitingForMore" ? ae("#pollposition-lobby-text").html("esperando a que todos los jugadores se unan") : f === "CanStart" ? (ae("#pollposition-lobby-text").html("pulsa este botón cuando todos se hayan unido"), ae("#pollposition-startgame").show()) : f === "Countdown" && (ae("#pollposition-lobby-text").html("pulsa este botón para cancelar el inicio de la partida"), ae("#pollposition-stopcountdown").show()), this.showScreen(".state-lobby")
        } else if (i === "Gameplay_Logo") this.showLogo();
        else if (i === "Gameplay_PickCategory") {
            if (n === "Gameplay_WaitForCategory") ae("#waitforcategory-text").html(`Esperando a que ${e.player} elija una categoría.`), this.showScreen(".state-waitforcategory");
            else if (n === "Gameplay_PickCategory") {
                ae("#choosecategory-text").html("Elige una categoría");
                let f = "";
        ...
        }, this.percentageDelayTime), this.showScreen(".state-enterpercentage"), this.currentRange.resize()) : n === "Gameplay_WaitForPercentage" ? (this.activeScreen !== ".state-waitforpercentage" && (ae(".state-waitforpercentage .question-text").html(e.question), ae("#waitingforpercentage-text").html(`Esperando a que ${e.player} ingrese un porcentaje.`)), this.showScreen(".state-waitforpercentage")) : n === "Gameplay_WaitForAllPercentages" ? this.showScreen(".state-waitforallpercentages") : n === "Gameplay_WaitForAudience" ? this.showScreen(".state-waitforaudience") : this.showLogo();
            ...
            if (n === "Gameplay_WaitForChooseUpOrDown") this.showScreen(".state-waitforupordown");
                ...
                ae(".state-chooseupordown .survey-text").html(e.survey), ae(".question-text").html(e.question), ae("#chooseupordown-text").html("La respuesta correcta tiene un porcentaje:");
                let f = "";
                for (o = 0; o < e.choices.length; o++) f += `<button type='button' data-choice='${e.choices[o].id.toString()}' class='pollposition-button pollposition-high-low-button pollposition-choice-button'><span>${e.choices[o].id.toString().replace("Much_Higher","Mucho más alto").replace("Much_Lower","Mucho más bajo").replace("Higher","Más alto").replace("Lower","Más bajo").replace("_"," ")}</span></button>`;
    ...
    updateAudience() {
        ...
        if (e === "Gameplay_EnterPercentage") {
            ...
            o += "<button type='button' data-choice='-1' class='pollposition-button pollposition-choice-button'><span>Esto no se aplica a mí</span></button>", ae("#pollposition-audiencechooseoption").html(o), this.showScreen(".state-audience-chose-option")
            ...
            this.hideLobbyButtons(), ae("#pollposition-post-lobby-text").html("¡Estás en el público!");
            let o = '<table class="table table-striped table-bordered"><thead><tr><th>Posición</th><th>Jugador</th><th>Puntaje</th></tr></thead><tbody>';
        ...
        } else ae(".state-audience-wait .audience-wait-text").html("¡Estás en el público! Espera tu momento para responder."), ae(".state-audience-wait .audience-usage-text").html("Las respuestas del público se utilizan cuando 5 o más miembros del público responden a la pregunta."), this.showScreen(".state-audience-wait")
    },
    hideLobbyButtons() {
    ...
    submitPercentage() {
        ...
        if (!this.isInt(t)) {
            ...
            return ae("#pollposition-submit-alert").html("¡no puedes dejarlo en blanco!"), n.removeClass("alert-info"), n.addClass("alert-danger"), n.show(), !1
        }
    ...
    submitChoice(t) {
        ...
        return ae(".pollposition-choice-button").attr("disabled", !0), this.client.isRole("player") ? this.client.send("SendMessageToRoomOwner", {
            ...
            type: "vote",
            vote: e
        }), ae("#pollposition-audiencechooseoption").html(""), ae(".state-audience-wait .audience-wait-text").html("¡Gracias, miembro del público!"), ae(".state-audience-wait .audience-usage-text").html("Las respuestas del público se utilizan cuando 5 o más miembros del público responden a la pregunta."), this.showScreen(".state-audience-wait")), !1
    },
    submitCategory(t) {
