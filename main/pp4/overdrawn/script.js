...
const Hx = mt.View.extend({
    ...
    qx = `<div class="overdrawnBold title">Dibuja tu nombre debajo</div>
<div id="nametag" class="nametag">
    <div id="header" class="nametagHeader overdrawnBold">Hola, soy</div>
    <div id="sketchpad" class="nametagBody"></div>
</div>
<button id="submitButton" class="button submitButton">Enviar</button>
<div id="vipWarning" class="text">Debes dibujar tu nombre y tocar enviar para proceder.</div>`,
    Wx = Pn.extend({
        defaults: {
            live: !0,
            size: {
    ...
    Yx = `<div class="text">Dibujo libre para todos</div>
...
<ul id="pre-sketchpad" class="nav nav-colors pre-sketchpad">
    <li class="pull-right button-pad">
        <button id="resetall" class="button">Reiniciar todo</button>
    </li>
...
`,
            ...
            en.fire({
                ...
                didOpen: () => {
                    this.censorView = new wl({
                        ...
                        model: new Xe.Model({
                            text: "Elige a alguien para censurar",
    ...
    <button id='censorOptions' class='button'>Opciones de censura</button>
    <div id='next-up'>
        <span id='next-up-span'>¡¡Tú sigues!!</span>
    </div>
    <div class="audienceInstruction col-xs-12 text">Los miembros del público tienen una reacción por dibujo, ¡así que utilízalas sabiamente!</div>
</div>`,
    a1 = mt.View.extend({
        bindings: {
            ":el": {
    ...
    d1 = Ni.extend({
        ...
        bindings: Ve.extend({}, Ni.prototype.bindings, {
            ...
            "#chosen": {
                observe: "chosen",
                onGet(t) {
                    return t ? "¡Gracias! ¡Cada voto cuenta!" : null
                }
            }
        }),
        initialize(t) {
        ...
        buttonClick(t) {
            ...
            return i || (i = "choose"), this.model.get("isPlayer") ? this.triggerMethod("client:message", {
                ...
                prompt: {
                    text: `Gracias. Tu elección: ${this.blob.choices[n].text}`
                },
                choices: []
            })), !1
        },
