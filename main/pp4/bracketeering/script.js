    ...
    zx = Da.extend({
        ...
        buttonClick(t) {
            ...
            return Pe("button").removeClass("active"), n.addClass("active"), a || (a = "choose"), this.model.get("isPlayer") ? a === "censor" ? (Pe("button").removeClass("active"), bn.close(), bn.fire({
                title: `¿Censurar ${this.model.get("choices")[i].text}?`,
                text: "no puedes deshacerlo después",
                background: "#2524c8",
                showCancelButton: !0,
                customClass: {
                ...
                confirmButtonText: "¡SÍ, CENSURARLO!",
                cancelButtonText: "CANCELAR"
            }).then(f => {
                ...
                type: "vote",
                vote: i
            }), this.promptComponent.model.set("html", `Gracias. Tu elección: <span>${this.model.get("choices")[i].html}</span>`), this.choicesList.collection.reset()), !1
        }
    });
const Hx = Px.extend({
