...
<button type="button" style='flex-grow:2;' class='voteButton button btn btn-lg'>
    <div class="voteTwistHeader text-left">Burlarse</div>
    ...
    <div class="voteResponse text-left">Respuesta</div>
    <div class="voteTwistFooter text-left">Burlarse</div>
