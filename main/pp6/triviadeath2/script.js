            ...
            if (i !== "back" && i !== "censorConfirm" && i !== "activateContentId")
                if (i === "changeName") try {
                        const o = await Ot.show("custom", {
                            ...
                            inputValidator: h => h ? h.length > 12 ? "Límite de 12 caracteres" : null : "¡Tienes que escribir algo!"
                        });
                        if (o.dismiss) return;
                        this.triggerMethod("client:message", {
                            name: o.value
    ...
    w1 = Za.extend({
        ...
        displayAudienceChoice(t) {
            ...
            if (this.model.get("roundType") !== "FinalRound") {
                ...
                if (!n) return e;
                e = `<div class="chosenText">Has elegido<br>${n.find(o=>o.key===t[0]).html}</div>`
            }
            return {
                html: e
            }
...
`,
    ...
    <button id="reset" class="button reset">Restablecer</button>\r
    <div class="visuallyhidden">\r
    ...
    L1 = mt.View.extend({
        ...
        update() {
            ...
            n.toLowerCase() === "busy" && (n = "OCUPADO"), n.toLowerCase() === "connected" && (n = "CONECTADO"), n.toLowerCase() === "wrongnumber" && (n = "EQUIVOCADO"), t && (t.val = e, t.status = n)
        },
        onRender() {
            this.stickit()
        },
    ...
    P1 = `<div>\r
    <div class="prompt">Desliza tu ficha para elegir un lugar donde caer.</div>\r
...
const Uc = function(e) {
    ...
    F1 = h1.extend({
        ...
        isPostGameLobby(t) {
            return t.prompt.html === "¿Qué quieres hacer?"
        },
        parseBlob(t) {
            const e = t;
            if (e.classes = e.classes || [], e.playerInfo = e.playerInfo || {}, e.playerInfo.classes = e.playerInfo.classes || [], e.isAudience && (e.playerInfo.username = "PÚBLICO", e.dollInfo = {
                    id: "Audience"
                ...
                if (this.isPostGameLobby(e) && e.artifact && e.choices.push({
                    ...
                    if (i) {
                        ...
                        if (o) {
                            const h = o[0];
                            let m = "";
                            h === "+" ? m = " mas " : h === "-" ? m = " menos " : h === "*" ? m = " multiplicado por " : h === "/" && (m = " dividido por ");
                            const E = i[0] + m + i[1];
                            let k = "";
