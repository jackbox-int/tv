...
const $x = Et.View.extend({
    ...
    <div class="arrow"></div>
    <p>Cuando otro comediante usa tu tema para un gran chiste, ¡obtienes <em>PUNTOS</em>!</p>
</div>`,
...
const Wx = xc.extend({
    ...
    parseBlob(t) {
        return t.playerInfo = t.playerInfo || {}, t.playerInfo.classes = t.playerInfo.classes || [], t.isAudience && (t.playerInfo.username = "PÚBLICO"), this.detectCatchphrase(t), this.detectFinalRound(t), t.state === "MakeSingleChoice" && t.announcePrompt && (t.textDescriptions = t.textDescriptions || [], t.textDescriptions.push({
            id: t.choiceId,
            category: "Prompt",
            text: t.prompt.html
        })), t
