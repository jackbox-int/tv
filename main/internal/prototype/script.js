...
var Pte = XR((kte, vw) => {
    ...
    const Tt = t => Gt(t) ? t : t == null ? "" : Pe(t) || dt(t) && (t.toString === qE || !je(t.toString)) ? JSON.stringify(t, VE, 2) : String(t),
        VE = (t, e) => e && e.__v_isRef ? VE(t, e.value) : ks(e) ? {
            [`Map(${e.size})`]: [...e.entries()].reduce((r, [n, s]) => (r[`${n} =>`] = s, r), {})
        } : nl(e) ? {
            [`Set(${e.size})`]: [...e.values()]
        } : dt(e) && !Pe(e) && !zE(e) ? String(e) : e,
        ft = {},
        Ls = [],
        sn = () => {},
        nN = () => !1,
        ...
        oN = /-(\w)/g,
        Sn = il(t => t.replace(oN, (e, r) => r ? r.toUpperCase() : "")),
        cN = /\B([A-Z])/g,
    ...
    let gv;
    const lN = () => gv || (gv = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
    let vn;
    class XE {
        constructor(e = !1) {
    ...
    const ch = t => {
        ...
        dN = ({
            ...
            if (t.length)
                for (let e = 0; e < t.length; e++) t[e].w |= ui
        },
        hN = t => {
            const {
                deps: e
            ...
            if (e.length) {
                ...
                for (let n = 0; n < e.length; n++) {
                    const s = e[n];
                    JE(s) && !ZE(s) ? s.delete(t) : e[r++] = s, s.w &= ~ui, s.n &= ~ui
                }
                e.length = r
            }
        },
    ...
    class lh {
        ...
        run() {
            ...
            try {
                return this.parent = tn, tn = this, oi = !0, ui = 1 << ++Na, Na <= Qf ? dN(this) : mv(this), this.fn()
            } finally {
                Na <= Qf && hN(this), ui = 1 << --Na, tn = this.parent, oi = r, this.parent = void 0, this.deferStop && this.stop()
            }
        }
        stop() {
            tn === this ? this.deferStop = !0 : this.active && (mv(this), this.onStop && this.onStop(), this.active = !1)
        }
    }
    ...
    function eb(t, e) {
        let r = !1;
        Na <= Qf ? ZE(t) || (t.n |= ui, r = !JE(t)) : r = !t.has(tn), r && (t.add(tn), tn.deps.push(t))
    }

    function Fn(t, e, r, n, s, o) {
        const c = Zf.get(t);
        if (!c) return;
        let u = [];
    ...
    const pN = ih("__proto__,__v_isRef,__isVue"),
        tb = new Set(Object.getOwnPropertyNames(Symbol).filter(t => t !== "arguments" && t !== "caller").map(t => Symbol[t]).filter(Wa)),
        gN = uh(),
        mN = uh(!1, !0),
        vN = uh(!0),
        yv = yN();
    ...
    function uh(t = !1, e = !1) {
        return function(n, s, o) {
            ...
            if (s === "__v_raw" && o === (t ? e ? kN : ab : e ? sb : ib).get(n)) return n;
            const c = Pe(n);
            if (!t && c && Je(yv, s)) return Reflect.get(yv, s, o);
            const u = Reflect.get(n, s, o);
            return (Wa(s) ? tb.has(s) : pN(s)) || (t || Nr(n, "get", s), e) ? u : Jt(u) ? c && oh(s) ? u : u.value : dt(u) ? t ? ob(u) : Un(u) : u
        }
    }
    const _N = rb(),
        EN = rb(!0);
    ...
    function rb(t = !1) {
        return function(r, n, s, o) {
            ...
            return r === rt(o) && (u ? Ka(s, c) && Fn(r, "set", n, s) : Fn(r, "add", n, s)), f
        }
    }
    ...
    function bN(t, e) {
        ...
        return n && r && Fn(t, "delete", e, void 0), n
    }

    function TN(t, e) {
        const r = Reflect.has(t, e);
        return (!Wa(e) || !tb.has(e)) && Nr(t, "has", e), r
    }
    ...
    function _v(t) {
        t = rt(t);
        const e = rt(this);
        return al(e).has.call(e, t) || (e.add(t), Fn(e, "add", t, t)), this
    }
    ...
    function Ev(t, e) {
        ...
        const c = s.call(r, t);
        return r.set(t, e), o ? Ka(e, c) && Fn(r, "set", t, e) : Fn(r, "add", t, e), this
    }
    ...
    function bv(t) {
        ...
        const o = e.delete(t);
        return s && Fn(e, "delete", t, void 0), o
    }
    ...
    function Tv() {
        const t = rt(this),
            e = t.size !== 0,
            r = t.clear();
        return e && Fn(t, "clear", void 0, void 0), r
    }
    ...
    function Un(t) {
        return Hs(t) ? t : hh(t, !1, nb, NN, ib)
    }

    function MN(t) {
        return hh(t, !1, wN, PN, sb)
    }

    function ob(t) {
        return hh(t, !0, ON, LN, ab)
    }
    ...
    const Ha = t => dt(t) ? Un(t) : t,
        ph = t => dt(t) ? ob(t) : t;

    function ub(t) {
        oi && tn && (t = rt(t), eb(t.dep || (t.dep = ch())))
    }
    ...
    class UN {
        ...
        set value(e) {
            ...
            e = r ? e : rt(e), Ka(e, this._rawValue) && (this._rawValue = e, this._value = r ? e : Ha(e), fb(this))
        }
    }
    ...
    class GN {
        constructor(e, r, n, s) {
            this._setter = r, this.dep = void 0, this.__v_isRef = !0, this[pb] = !1, this._dirty = !0, this.effect = new lh(e, () => {
                this._dirty || (this._dirty = !0, fb(this))
            }), this.effect.computed = this, this.effect.active = this._cacheable = !s, this.__v_isReadonly = n
        }
        get value() {
            const e = rt(this);
            return ub(e), (e._dirty || !e._cacheable) && (e._dirty = !1, e._value = e.effect.run()), e._value
        }
        set value(e) {
            this._setter(e)
        }
    ...
    function mh(t) {
        (!ir.length || !ir.includes(t, Va && t.allowRecurse ? bn + 1 : bn)) && (t.id == null ? ir.push(t) : ir.splice(VN(t.id), 0, t), mb())
    }

    function mb() {
        !Va && !rd && (rd = !0, gh = gb.then(yb))
    }
    ...
    function qN(t) {
        Pe(t) ? Ds.push(...t) : (!xn || !xn.includes(t, t.allowRecurse ? Wi + 1 : Wi)) && Ds.push(t), mb()
    }

    function Sv(t, e = Va ? bn + 1 : 0) {
        for (; e < ir.length; e++) {
            const r = ir[e];
    ...
    function vb(t) {
        if (Ds.length) {
            ...
            for (xn = e, xn.sort((r, n) => Ya(r) - Ya(n)), Wi = 0; Wi < xn.length; Wi++) xn[Wi]();
            xn = null, Wi = 0
        }
    }
    ...
    function yb(t) {
        ...
        try {
            ...
            bn = 0, ir.length = 0, vb(), Va = !1, gh = null, (ir.length || Ds.length) && yb()
        }
    }
    ...
    function QN(t, e, r) {
        ...
        } else return (s || u) && (!u || !u.$stable) ? !0 : n === c ? !1 : n ? c ? Ov(n, c, h) : !0 : !!c;
        return !1
    }
    ...
    function Eb(t, e, {
        ...
        const L = () => {
            if (!!B.active)
                if (e) {
                    const I = B.run();
                    (n || h || (m ? I.some((K, Y) => Ka(K, C[Y])) : Ka(I, C))) && (_ && _(), Yr(e, u, 3, [I, C === wv ? void 0 : C, b]), C = I)
                } else B.run()
        };
        L.allowRecurse = !!e;
        let M;
    ...
    function iP(t, e, r) {
        const n = this.proxy,
            s = Gt(t) ? t.includes(".") ? bb(n, t) : () => n[t] : t.bind(n, n);
        let o;
    ...
    const Wr = [Function, Array],
        aP = {
            ...
            setup(t, {
                ...
                let s;
                return () => {
                    const o = e.default && Ob(e.default(), !0);
    ...
    function nd(t, e, r, n) {
        const {
            ...
            onAfterAppear: I,
            onAppearCancelled: K
        } = e, Y = String(t.key), G = Sb(r, t), j = (oe, ue) => {
            oe && Yr(oe, n, 9, ue)
        }, z = (oe, ue) => {
            const Ie = ue[1];
    ...
    function Ob(t, e = !1, r) {
        ...
        for (let o = 0; o < t.length; o++) {
            ...
            c.type === $t ? (c.patchFlag & 128 && s++, n = n.concat(Ob(c.children, e, u))) : (e || c.type !== an) && n.push(u != null ? fi(c, {
                key: u
            }) : c)
        }
        if (s > 1)
    ...
    const Bn = t => (e, r = Vt) => (!za || t === "sp") && fl(t, e, r),
        Cb = Bn("bm"),
        Eh = Bn("m"),
        uP = Bn("bu"),
        fP = Bn("u"),
    ...
    function Oh(t, e, r = !0, n = !1) {
        ...
        if (s) {
            ...
            if (t === Th) {
                const u = KP(o, !1);
                if (u && (u === e || u === Sn(e) || u === sl(Sn(e)))) return o
            }
            const c = Iv(s[t] || o[t], e) || Iv(s.appContext[t], e);
            return !c && n ? o : c
        }
    }

    function Iv(t, e) {
        return t && (t[e] || t[Sn(e)] || t[sl(Sn(e))])
    }
    ...
    const sd = t => t ? Ub(t) ? pl(t) || t.proxy : sd(t.parent) : null,
    ...
    function yP(t) {
        const e = wh(t),
            r = t.proxy,
            n = t.ctx;
        ad = !1, e.beforeCreate && $v(e.beforeCreate, t, "bc");
        const {
            data: s,
            computed: o,
            methods: c,
        ...
        if (u)
            for (const Ee in u) Ab(u[Ee], n, r, Ee);
        if (f) {
        ...
        if (de(Cb, _), de(Eh, b), de(uP, C), de(fP, L), de(oP, M), de(cP, B), de(gP, oe), de(pP, z), de(hP, ie), de(Ib, K), de(bh, G), de(dP, ue), Pe(Ie))
            if (Ie.length) {
    ...
    function Ab(t, e, r, n) {
        ...
        if (Gt(t)) {
            ...
            if (Pe(t)) t.forEach(o => Ab(o, e, r, n));
            else {
    ...
    function SP(t, e, r, n = !1) {
        const s = {},
            o = {};
        kc(o, hl, 1), t.propsDefaults = Object.create(null), Rb(t, e, s, o);
    ...
    function Rb(t, e, r, n) {
        ...
        if (e)
            for (let f in e) {
                ...
                const h = e[f];
                let m;
                s && Je(s, m = Sn(f)) ? !o || !o.includes(m) ? r[m] = h : (u || (u = {}))[m] = h : cl(t.emitsOptions, f) || (!(f in n) || h !== n[f]) && (n[f] = h, c = !0)
            }
        if (o) {
            const f = rt(r),
                h = u || ft;
    ...
    function Lv(t, e) {
        return Pe(e) ? e.findIndex(r => Pv(r, t)) : je(e) && Pv(e, t) ? 0 : -1
    }
    const Pb = t => t[0] === "_" || t === "$stable",
        ...
        CP = (t, e) => {
            if (t.vnode.shapeFlag & 32) {
                const r = e._;
                r ? (t.slots = rt(e), kc(e, "_", r)) : Lb(e, t.slots = {})
        ...
        IP = (t, e, r) => {
            ...
            if (n.shapeFlag & 32) {
                const u = e._;
                u ? r && u === 1 ? o = !1 : (Qt(s, e), !r && u === 1 && delete s._) : (o = !e.$stable, Lb(e, s)), c = e
            } else e && (kb(t, e), c = {
                default: 1
            });
            if (o)
                for (const u in s) !Pb(u) && !(u in c) && delete s[u]
        };
    ...
    function ld(t, e, r, n, s = !1) {
        ...
        const o = n.shapeFlag & 4 ? pl(n.component) || n.component.proxy : n.el,
            ...
            _ = u.setupState;
        if (h != null && h !== f && (Gt(h) ? (m[h] = null, Je(_, h) && (_[h] = null)) : Jt(h) && (h.value = null)), je(f)) ci(f, u, 12, [c, m]);
        else {
            const b = Gt(f),
                C = Jt(f);
            if (b || C) {
    ...
    function NP(t, e) {
        ...
        const {
            ...
            if (g === p) return;
            g && !Ki(g, p) && (D = Et(g), Ct(g, U, V, !0), g = null), p.patchFlag === -2 && (Q = !1, p.dynamicChildren = null);
            const {
                type: A,
                ref: W,
                shapeFlag: he
            ...
            for (let re = 0; re < p.length; re++) {
                const Q = g[re],
                    A = p[re],
                    W = Q.el && (Q.type === $t || !Ki(Q, A) || Q.shapeFlag & 70) ? _(Q.el) : O;
            ...
            $e && (re = re ? re.concat($e) : $e), g == null ? (n(A, O, D), n(W, O, D), ue(p.children, O, W, U, V, ce, re, Q)) : he > 0 && he & 64 && pe && g.dynamicChildren ? (Ce(g.dynamicChildren, pe, O, U, V, ce, re), (p.key != null || U && p === U.subTree) && Db(g, p, !0)) : Se(g, p, O, W, U, V, ce, re, Q)
            ...
            g.vnode = p, g.next = null, OP(g, p.props, D, O), IP(g, p.children, O), Qs(), Sv(), ea()
            ...
            let pe;
            for (pe = 0; pe < he; pe++) {
                const $e = p[pe] = Q ? ri(p[pe]) : _n(p[pe]);
            ...
            if (A > he) {
                if (A <= pe) {
                    const $e = pe + 1,
                        Le = $e < W ? p[$e].el : D;
                    for (; A <= pe;) B(null, p[A] = Q ? ri(p[A]) : _n(p[A]), O, Le, U, V, ce, re, Q), A++
                }
            } else if (A > pe)
                for (; A <= he;) Ct(g[A], U, V, !0), A++;
            else {
                const $e = A,
                    Le = A,
                    w = new Map;
                for (A = Le; A <= pe; A++) {
                    const Te = p[A] = Q ? ri(p[A]) : _n(p[A]);
                    ...
                    if (Te.key != null) ot = w.get(Te.key);
                        ...
                        for (T = Le; T <= pe; T++)
                            if (ee[T - Le] === 0 && Ki(Te, p[T])) {
                                ot = T;
                                break
                            } ot === void 0 ? Ct(Te, U, V, !0) : (ee[ot - Le] = A + 1, ot >= X ? X = ot : P = !0, B(Te, p[ot], O, null, U, V, ce, re, Q), N++)
                }
                const _e = P ? PP(ee) : Ls;
            ...
            if (Le && (w = ce && ce.onVnodeBeforeUnmount) && pn(w, p, g), W & 6) pr(g.component, O, D);
                ...
                $e && Li(g, null, p, "beforeUnmount"), W & 64 ? g.type.remove(g, p, O, U, Lt, D) : A && (V !== $t || he > 0 && he & 64) ? nt(A, p, O, !1, !0) : (V === $t && he & 384 || !U && W & 16) && nt(Q, p, O), D && Sr(g)
            ...
            D && Cc(D), U.stop(), V && (V.active = !1, Ct(ce, g, p, O)), re && Er(re, p), Er(() => {
                g.isUnmounted = !0
            ...
            for (let ce = V; ce < g.length; ce++) Ct(g[ce], p, O, D, U)
        }, Et = g => g.shapeFlag & 6 ? Et(g.component.subTree) : g.shapeFlag & 128 ? g.suspense.next() : b(g.anchor || g.el), it = (g, p, O) => {
            g == null ? p._vnode && Ct(p._vnode, null, null, !0) : B(p._vnode || null, g, p, null, null, null, O), Sv(), vb(), p._vnode = g
        }, Lt = {
            p: B,
            um: Ct,
            m: Ze,
    ...
    function Db(t, e, r = !1) {
        ...
        if (Pe(n) && Pe(s))
            for (let o = 0; o < n.length; o++) {
                const c = n[o];
                let u = s[o];
                u.shapeFlag & 1 && !u.dynamicChildren && ((u.patchFlag <= 0 || u.patchFlag === 32) && (u = s[o] = ri(s[o]), u.el = c.el), r || Db(c, u))
            }
    }
    ...
    function le(t, e, r, n, s, o) {
        return Mb(ae(t, e, r, n, s, o, !0))
    }

    function On(t, e, r, n, s) {
        return Mb(xt(t, e, r, n, s, !0))
    }
    ...
    function ae(t, e = null, r = null, n = 0, s = null, o = t === $t ? 0 : 1, c = !1, u = !1) {
        const f = {
            __v_isVNode: !0,
            __v_skip: !0,
            type: t,
    ...
    function xP(t, e = null, r = null, n = 0, s = null, o = !1) {
        ...
        if (HP(t) && (t = t.__vccOpts), e) {
            ...
            u && !Gt(u) && (e.class = qe(u)), dt(f) && (cb(f) && !Pe(f) && (f = Qt({}, f)), e.style = el(f))
        }
    ...
    function DP(t) {
        return t ? cb(t) || hl in t ? Qt({}, t) : t : null
    }
    ...
    function fi(t, e, r = !1) {
        ...
        return {
            ...
            patchFlag: e && t.type !== $t ? o === -1 ? 16 : o | 16 : o,
    ...
    function We(t = "", e = !1) {
        return e ? (se(), On(an, null, t)) : xt(an, null, t)
    }

    function _n(t) {
        return t == null || typeof t == "boolean" ? xt(an) : Pe(t) ? xt($t, null, t.slice()) : typeof t == "object" ? ri(t) : xt(dl, null, String(t))
    }
    ...
    function jP(t, e) {
        const r = t.type;
        t.accessCache = Object.create(null), t.proxy = lb(new Proxy(t.ctx, vP));
        const {
            setup: n
        } = r;
        if (n) {
    ...
    function xv(t, e, r) {
        je(e) ? t.type.__ssrInlineRender ? t.ssrRender = e : t.render = e : dt(e) && (t.setupState = hb(e)), Bb(t, r)
    }
    let Dv;
    ...
    function pl(t) {
        if (t.exposed) return t.exposeProxy || (t.exposeProxy = new Proxy(hb(lb(t.exposed)), {
            get(e, r) {
    ...
    const VP = "3.2.39",
        ...
        Mv = Hi && Hi.createElement("template"),
        qP = {
            insert: (t, e, r) => {
    ...
    function fd(t, e, r) {
        if (Pe(r)) r.forEach(n => fd(t, e, n));
            ...
            const n = JP(t, e);
            Fv.test(r) ? t.setProperty(ss(n), r.replace(Fv, ""), "important") : t[n] = r
        }
    }
    ...
    function ZP(t, e, r, n, s) {
        if (n && e.startsWith("xlink:")) r == null ? t.removeAttributeNS(Bv, e.slice(6, e.length)) : t.setAttributeNS(Bv, e, r);
        else {
            const o = ZR(e);
            r == null || o && !KE(r) ? t.removeAttribute(e) : t.setAttribute(e, o ? "" : r)
        }
    }
    ...
    function aL(t) {
        ...
        if (jv.test(t)) {
            e = {};
            let n;
            for (; n = t.match(jv);) t = t.slice(0, t.length - n[0].length), e[n[0].toLowerCase()] = !0
        }
    ...
    function uL(t, e, r, n) {
        return n ? !!(e === "innerHTML" || e === "textContent" || e in t && Gv.test(e) && je(r)) : e === "spellcheck" || e === "draggable" || e === "translate" || e === "form" || e === "list" && t.tagName === "INPUT" || e === "type" && t.tagName === "TEXTAREA" || Gv.test(e) && Gt(r) ? !1 : e in t
    }
    const Zn = "transition",
        Ca = "animation",
        gl = (t, {
    ...
    gl.props = Qt({}, Tb.props, Gb);
    const xi = (t, e = []) => {
            Pe(t) ? t.forEach(r => r(...e)) : t && t(...e)
        },
        Wv = t => t ? Pe(t) ? t.some(e => e.length > 1) : t.length > 1 : !1;

    function fL(t) {
        const e = {};
        for (const fe in t) fe in Gb || (e[fe] = t[fe]);
        if (t.css === !1) return e;
        const {
            name: r = "v",
            type: n,
            ...
            const te = fe ? ie : K,
                de = () => ue(we, fe, F);
            xi(te, [we, de]), Kv(() => {
                Di(we, fe ? f : o), Qn(we, fe ? m : u), Wv(te) || Hv(we, n, M, de)
            })
        };
        return Qt(e, {
            onBeforeEnter(fe) {
                xi(I, [fe]), Qn(fe, o), Qn(fe, c)
            },
            onBeforeAppear(fe) {
                xi(z, [fe]), Qn(fe, f), Qn(fe, h)
            },
            onEnter: Ce(!1),
            onAppear: Ce(!0),
            onLeave(fe, we) {
                fe._isLeaving = !0;
                const F = () => Ie(fe, we);
                Qn(fe, _), gL(), Qn(fe, b), Kv(() => {
                    !fe._isLeaving || (Di(fe, _), Qn(fe, C), Wv(G) || Hv(fe, n, B, F))
                }), xi(G, [fe, F])
            },
            onEnterCancelled(fe) {
                ue(fe, !1), xi(Y, [fe])
    ...
    function pL(t, e) {
        ...
        let m = null,
            _ = 0,
            b = 0;
        e === Zn ? c > 0 && (m = Zn, _ = c, b = o.length) : e === Ca ? h > 0 && (m = Ca, _ = h, b = f.length) : (_ = Math.max(c, h), m = _ > 0 ? c > h ? Zn : Ca : null, b = m ? m === Zn ? o.length : f.length : 0);
        const C = m === Zn && /\b(transform|all)(,|$)/.test(r[Zn + "Property"]);
        return {
            type: m,
            timeout: _,
            propCount: b,
    ...
    function Vv(t, e) {
        ...
        return Math.max(...e.map((r, n) => Yv(r) + Yv(t[n])))
    }
    ...
    const zv = {
            created(t, {
                ...
                }), e || (Vi(t, "compositionstart", mL), Vi(t, "compositionend", qv), Vi(t, "change", qv))
            },
            mounted(t, {
                value: e
            }) {
    ...
    function Xv(t, {
        ...
        t._modelValue = e, Pe(e) ? t.checked = HE(e, n.props.value) > -1 : nl(e) ? t.checked = e.has(n.props.value) : e !== r && (t.checked = tl(e, Wb(t, !0)))
    }
    ...
    function NL(t, e, r, n, s, o) {
        ...
        return se(), le("div", IL, [ae("div", $L, [t.player.prompt ? tt((se(), le("p", AL, null, 512)), [
            [c, t.player.prompt]
        ]) : We("", !0), (se(!0), le($t, null, io(t.player.choices, (u, f) => (se(), le("button", {
            key: f,
            class: qe({
    ...
    function Nk(t) {
        return t == null ? t === void 0 ? Rk : Ak : ey && ey in Object(t) ? Ik(t) : $k(t)
    }
    var ra = Nk;
    ...
    function UD(t) {
        ...
        return new sy(e).set(new sy(t)), e
    }
    var kh = UD,
        BD = kh;
    ...
    function lF(t, e, r, n, s, o, c) {
        ...
        if (_) {
            var b = dy(f),
                C = !b && nF(f),
                L = !b && !C && oF(f);
            m = f, b || C || L ? dy(u) ? m = u : rF(u) ? m = eF(u) : C ? (_ = !1, m = Z2(f, !0)) : L ? (_ = !1, m = Q2(f, !0)) : m = [] : aF(f) || fy(f) ? (m = u, fy(u) ? m = cF(u) : (!sF(u) || iF(u)) && (m = tF(f))) : _ = !1
        }
        _ && (c.set(f, m), s(m, f, n, o, c), c.delete(f)), uy(t, r, m)
    }
    var uF = lF,
        fF = qb,
        dF = Xb,
    ...
    function SF(t, e, r) {
        return e = py(e === void 0 ? t.length - 1 : e, 0),
            function() {
                for (var n = arguments, s = -1, o = py(n.length - e, 0), c = Array(o); ++s < o;) c[s] = n[e + s];
                s = -1;
    ...
    let hr = Fp;
    ge(hr, "queryParams", new URLSearchParams(window.location.search)), ge(hr, "getQueryParam", e => Fp.queryParams.get(e)), ge(hr, "sleep", e => new Promise(r => {
    ...
    var sU = function() {
        ...
        aU = sU,
        oU = function() {
            return typeof my != "function" || typeof Symbol != "function" || typeof my("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : aU()
        },
    ...
    var hf = function() {
        ...
        Ss = oU(),
        ni = Object.getPrototypeOf || function(t) {
            return t.__proto__
        },
        Is = {},
        mU = typeof Uint8Array > "u" ? Xe : ni(Uint8Array),
        Us = {
            "%AggregateError%": typeof AggregateError > "u" ? Xe : AggregateError,
            "%Array%": Array,
            "%ArrayBuffer%": typeof ArrayBuffer > "u" ? Xe : ArrayBuffer,
            "%ArrayIteratorPrototype%": Ss ? ni([][Symbol.iterator]()) : Xe,
            ...
            "%isFinite%": isFinite,
            "%isNaN%": isNaN,
            "%IteratorPrototype%": Ss ? ni(ni([][Symbol.iterator]())) : Xe,
            "%JSON%": typeof JSON == "object" ? JSON : Xe,
            "%Map%": typeof Map > "u" ? Xe : Map,
            "%MapIteratorPrototype%": typeof Map > "u" || !Ss ? Xe : ni(new Map()[Symbol.iterator]()),
            "%Math%": Math,
            "%Number%": Number,
            "%Object%": Object,
            ...
            "%SetIteratorPrototype%": typeof Set > "u" || !Ss ? Xe : ni(new Set()[Symbol.iterator]()),
            "%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? Xe : SharedArrayBuffer,
            "%String%": String,
            "%StringIteratorPrototype%": Ss ? ni("" [Symbol.iterator]()) : Xe,
            "%Symbol%": Ss ? Symbol : Xe,
            "%SyntaxError%": Ys,
            "%ThrowTypeError%": gU,
            "%TypedArray%": mU,
        ...
        yy = oo.call(Function.call, String.prototype.replace),
        ...
        SU = function(e) {
            ...
            var s = [];
            return yy(e, bU, function(o, c, u, f) {
                s[s.length] = u ? yy(f, TU, "$1") : c || o
            }), s
        },
        OU = function(e, r) {
            var n = e,
                s;
            if (Wc(vy, n) && (s = vy[n], n = "%" + s[0] + "%"), Wc(Us, n)) {
                var o = Us[n];
    ...
    var Gh = typeof Map == "function" && Map.prototype,
        pf = Object.getOwnPropertyDescriptor && Gh ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null,
        Hc = Gh && pf && typeof pf.get == "function" ? pf.get : null,
        RU = Gh && Map.prototype.forEach,
        Wh = typeof Set == "function" && Set.prototype,
        gf = Object.getOwnPropertyDescriptor && Wh ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null,
        Vc = Wh && gf && typeof gf.get == "function" ? gf.get : null,
        NU = Wh && Set.prototype.forEach,
        ...
        _y = kU ? WeakRef.prototype.deref : null,
        ...
        Sy = (typeof Reflect == "function" ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(t) {
            return t.__proto__
        } : null);
    ...
    function Oy(t, e) {
        ...
        if (typeof t == "number") {
            ...
            if (n !== t) {
                var s = String(n),
                    o = Kh.call(e, s.length + 1);
                return ai.call(s, r, "$&_") + "." + ai.call(ai.call(o, /([0-9]{3})/g, "$&_"), /_$/, "")
            }
        }
        return ai.call(e, r, "$&_")
    }
    var md = AU,
        wy = md.custom,
        Cy = vT(wy) ? wy : null,
        jU = function t(e, r, n, s) {
            var o = r || {};
            if (ii(o, "quoteStyle") && o.quoteStyle !== "single" && o.quoteStyle !== "double") throw new TypeError('option "quoteStyle" must be "single" or "double"');
            if (ii(o, "maxStringLength") && (typeof o.maxStringLength == "number" ? o.maxStringLength < 0 && o.maxStringLength !== 1 / 0 : o.maxStringLength !== null)) throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
            var c = ii(o, "customInspect") ? o.customInspect : !0;
            if (typeof c != "boolean" && c !== "symbol") throw new TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
            if (ii(o, "indent") && o.indent !== null && o.indent !== "	" && !(parseInt(o.indent, 10) === o.indent && o.indent > 0)) throw new TypeError('option "indent" must be "\\t", an integer > 0, or `null`');
            if (ii(o, "numericSeparator") && typeof o.numericSeparator != "boolean") throw new TypeError('option "numericSeparator", if provided, must be `true` or `false`');
            ...
            function b(we, F, te) {
                if (F && (s = BU.call(s), s.push(F)), te) {
                    ...
                    return ii(o, "quoteStyle") && (de.quoteStyle = o.quoteStyle), t(we, de, n + 1, s)
                }
                return t(we, o, n + 1, s)
            }
            if (typeof e == "function" && !Iy(e)) {
                var C = XU(e),
                    L = fc(e, b);
                return "[Function" + (C ? ": " + C : " (anonymous)") + "]" + (L.length > 0 ? " { " + En.call(L, ", ") + " }" : "")
            }
            if (vT(e)) {
                var M = qs ? ai.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : gd.call(e);
                return typeof e == "object" && !qs ? $a(M) : M
            }
            if (rB(e)) {
                for (var B = "<" + Ey.call(String(e.nodeName)), I = e.attributes || [], K = 0; K < I.length; K++) B += " " + I[K].name + "=" + mT(GU(I[K].value), "double", o);
                return B += ">", e.childNodes && e.childNodes.length && (B += "..."), B += "</" + Ey.call(String(e.nodeName)) + ">", B
            }
            if (vd(e)) {
            ...
            if (KU(e)) {
                var G = fc(e, b);
                return !("cause" in Error.prototype) && "cause" in e && !gT.call(e, "cause") ? "{ [" + String(e) + "] " + En.call(by.call("[cause]: " + b(e.cause), G), ", ") + " }" : G.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + En.call(G, ", ") + " }"
            }
            if (typeof e == "object" && c) {
                if (Cy && typeof e[Cy] == "function" && md) return md(e, {
                    depth: m - n
                });
            ...
            if (!WU(e) && !Iy(e)) {
                var ie = fc(e, b),
                    oe = Sy ? Sy(e) === Object.prototype : e instanceof Object || e.constructor === Object,
                    ue = e instanceof Object ? "" : "null prototype",
                    Ie = !oe && ar && Object(e) === e && ar in e ? Kh.call(vi(e), 8, -1) : ue ? "Object" : "",
                    Ce = oe || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "",
                    fe = Ce + (Ie || ue ? "[" + En.call(by.call([], Ie || [], ue || []), ": ") + "] " : "");
    ...
    function QU(t) {
        if (!_y || !t || typeof t != "object") return !1;
        try {
            return _y.call(t), !0
        } catch {}
        return !1
    ...
    function _T(t, e) {
        if (t.length > e.maxStringLength) {
            ...
            return _T(Kh.call(t, 0, e.maxStringLength), e) + n
        }
        var s = ai.call(ai.call(t, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, nB);
...
` + e.prev
    ...
    function fc(t, e) {
        ...
        if (r) {
            n.length = t.length;
            for (var s = 0; s < t.length; s++) n[s] = ii(t, s) ? e(t[s], t) : ""
        }
        ...
        for (var f in t) !ii(t, f) || r && String(Number(f)) === f && f < t.length || qs && c["$" + f] instanceof Symbol || (pT.call(/[^\w$]/, f) ? n.push(e(f, t) + ": " + e(t[f], t)) : n.push(f + ": " + e(t[f], t)));
    ...
    var Hh = jh,
        ...
        DB = function t(e, r, n, s, o, c, u, f, h, m, _, b, C, L, M, B) {
            ...
            if (typeof f == "function" ? I = f(r, I) : I instanceof Date ? I = _(I) : n === "comma" && Mn(I) && (I = _d.maybeMap(I, function(Se) {
            ...
            if (xB(I) || _d.isBuffer(I)) {
                if (u) {
                    ...
                    if (n === "comma" && L) {
                        ...
                        return [C(z) + (s && Mn(I) && ie.length === 1 ? "[]" : "") + "=" + oe]
                    }
            ...
            for (var we = s && Mn(I) && I.length === 1 ? r + "[]" : r, F = 0; F < Ce.length; ++F) {
                var te = Ce[F],
                    de = typeof te == "object" && typeof te.value < "u" ? te.value : I[te];
                if (!(c && de === null)) {
                    var Ee = Mn(I) ? typeof n == "function" ? n(we, te) : we : we + (m ? "." + te : "[" + te + "]");
                    B.set(e, Y);
                    var ve = TT();
        ...
        MB = function(e) {
            ...
            var s = Ma.formatters[n],
                o = Xt.filter;
            return (typeof e.filter == "function" || Mn(e.filter)) && (o = e.filter), {
        ...
        FB = function(t, e) {
            ...
            var u;
            e && e.arrayFormat in Ay ? u = e.arrayFormat : e && "indices" in e ? u = e.indices ? "indices" : "repeat" : u = "indices";
            var f = Ay[u];
    ...
    var oj = $s,
        ...
        Py = Bs && typeof Bs.apply == "function" ? Bs.apply : function(e, r, n) {
    ...
    lt.prototype.emit = function(e) {
        ...
        if (typeof f == "function") Py(f, this, r);
            ...
            for (var h = f.length, m = PT(f, h), n = 0; n < h; ++n) Py(m[n], this, r);
        return !0
    };
    ...
    (function(t, e) {
        (function(r, n) {
            ...
            var xe = new Se,
                ...
                Ct = function() {};
            Ct.prototype.stopPropagation = function() {}, Ct.prototype.stopImmediatePropagation = function() {}, Ct.prototype.initEvent = function(T, N, S) {
        ...
        N3 = vt({
            ...
            methods: {
                createCanvas() {
                    ...
                    this.canvas = Un(new lW(t, this.player.doodle, this.canvasOptions))
                },
                onPointerBoxStart(t) {
    ...
    (function(t, e) {
        (function() {
            var r, n = "4.17.21",
                ...
                ng = "(?:" + Yl + "(?:D|LL|M|RE|S|T|VE))?",
                ig = Xw + "?",
                sg = "[" + Yp + "]?",
                Zw = "(?:" + eg + "(?:" + [Qp, zl, Xl].join("|") + ")" + sg + ig + ")*",
                Qw = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",
                e0 = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",
                ag = sg + ig + Zw,
                t0 = "(?:" + [zw, zl, Xl].join("|") + ")" + ag,
                r0 = "(?:" + [Qp + Eo + "?", Eo, zl, Xl, qw].join("|") + ")",
                n0 = RegExp(Yl, "g"),
                i0 = RegExp(Eo, "g"),
                Jl = RegExp(ql + "(?=" + ql + ")|" + r0 + ag, "g"),
                s0 = RegExp([ls + "?" + Jp + "+" + rg + "(?=" + [zp, ls, "$"].join("|") + ")", Jw + "+" + ng + "(?=" + [zp, ls + tg, "$"].join("|") + ")", ls + "?" + tg + "+" + rg, ls + "+" + ng, e0, Qw, Xp, t0].join("|"), "g"),
                a0 = RegExp("[" + eg + _o + Wp + Yp + "]"),
            ...
            var u0 = {
                ...
                p0 = parseFloat,
                g0 = parseInt,
                og = typeof Pt == "object" && Pt && Pt.Object === Object && Pt,
                m0 = typeof self == "object" && self && self.Object === Object && self,
                qt = og || m0 || Function("return this")(),
                Zl = e && !e.nodeType && e,
                ...
                lg = xr && xr.isArrayBuffer,
                ug = xr && xr.isDate,
                fg = xr && xr.isMap,
                dg = xr && xr.isRegExp,
                hg = xr && xr.isSet,
                pg = xr && xr.isTypedArray;
            ...
            function Eg(k) {
                return k && k.slice(0, Og(k) + 1).replace(Vl, "")
            }
            ...
            var B0 = function k(q) {
                    ...
                    var H = q.Array,
                        ...
                        Hn = q.Symbol,
                        Ao = q.Uint8Array,
                        Cg = $o ? $o.allocUnsafe : r,
                        Ro = Sg(ut.getPrototypeOf, ut),
                        Ig = ut.create,
                        $g = ps.propertyIsEnumerable,
                        No = Oo.splice,
                        Ag = Hn ? Hn.isConcatSpreadable : r,
                        da = Hn ? Hn.iterator : r,
                        wi = Hn ? Hn.toStringTag : r,
                        Po = function() {
                            try {
                        ...
                        s1 = Ni(gs),
                        a1 = Ni(pa),
                        Do = Hn ? Hn.prototype : r,
                        ma = Do ? Do.valueOf : r,
                        Pg = Do ? Do.toString : r;

                    function y(i) {
                        if (It(i) && !Fe(i) && !(i instanceof Ve)) {
                            if (i instanceof Fr) return i;
                            if (ct.call(i, "__wrapped__")) return Lm(i)
                        }
                        return new Fr(i)
                    }
                    var vs = function() {
                    ...
                    function l1() {
                        ...
                        if (!l || !d && v == x && Oe == x) return rm(i, this.__actions__);
                        var Re = [];
                        e: for (; x-- && me < Oe;) {
                            J += a;
                    ...
                    wn.prototype.clear = g1, wn.prototype.delete = m1, wn.prototype.get = v1, wn.prototype.has = y1, wn.prototype.set = _1;
                    ...
                    Cn.prototype.clear = E1, Cn.prototype.delete = b1, Cn.prototype.get = T1, Cn.prototype.has = S1, Cn.prototype.set = O1;
                    ...
                    function Lg(i, a) {
                        var l = Fe(i),
                            ...
                            R = $ ? au(i.length, j0) : [],
                            x = R.length;
                        for (var J in i)(a || ct.call(i, J)) && !($ && (J == "length" || v && (J == "offset" || J == "parent") || E && (J == "buffer" || J == "byteLength" || J == "byteOffset") || Rn(J, x))) && R.push(J);
                        return R
                    }
                    ...
                    function hu(i, a, l) {
                        (l !== r && !Zr(i[a], l) || l === r && !(a in i)) && In(i, a, l)
                    }

                    function va(i, a, l) {
                        var d = i[a];
                        (!(ct.call(i, a) && Zr(d, l)) || l === r && !(a in i)) && In(i, a, l)
                    }
                    ...
                    function Ur(i, a, l, d, v, E) {
                        ...
                        if (Z) {
                            ...
                            var ne = nr(i),
                                me = ne == kt || ne == g;
                            if (Xn(i)) return sm(i, R);
                            if (ne == U || ne == er || me && !v) {
                                if ($ = x || me ? {} : Om(i), !R) return x ? dC(i, x1($, i)) : fC(i, xg($, i))
                            } else {
                                if (!ht[ne]) return v ? i : {};
                                $ = OC(i, ne, R)
                            }
                        ...
                        var Oe = E.get(i);
                        if (Oe) return Oe;
                        E.set(i, $), Qm(i) ? i.forEach(function(Ne) {
                            $.add(Ur(Ne, a, l, Ne, i, E))
                        }) : Jm(i) && i.forEach(function(Ne, He) {
                    ...
                    function F1(i, a, l, d) {
                        var v = i.length;
                        for (l = Be(l), l < 0 && (l = -l > v ? 0 : v + l), d = d === r || d > v ? v : Be(d), d < 0 && (d += v), d = l > d ? 0 : tv(d); l < d;) i[l++] = a;
                        return i
                    }
                    ...
                    function zt(i, a, l, d, v) {
                        ...
                        for (l || (l = CC), v || (v = []); ++E < $;) {
                            var R = i[E];
                            a > 0 && l(R) ? a > 1 ? zt(R, a - 1, l, d, v) : Wn(v, R) : d || (v[v.length] = R)
                        }
                        return v
                    }
                    var gu = fm(),
                    ...
                    function Ea(i, a, l, d, v) {
                        return i === a ? !0 : i == null || a == null || !It(i) && !It(a) ? i !== i && a !== a : H1(i, a, l, d, Ea, v)
                    }
                    ...
                    function H1(i, a, l, d, v, E) {
                        ...
                        if (me && !Z) return E || (E = new Jr), $ || bs(i) ? bm(i, a, l, d, v, E) : yC(i, a, x, l, d, v, E);
                        if (!(l & L)) {
                    ...
                    function z1(i) {
                        return It(i) && nc(i.length) && !!yt[cr(i)]
                    }

                    function Kg(i) {
                        return typeof i == "function" ? i : i == null ? yr : typeof i == "object" ? Fe(i) ? Yg(i[0], i[1]) : Vg(i) : dv(i)
                    }
                    ...
                    function Vg(i) {
                        var a = Du(i);
                        return a.length == 1 && a[0][2] ? Cm(a[0][0], a[0][1]) : function(l) {
                            return l === i || _u(l, i, a)
                        }
                    }

                    function Yg(i, a) {
                        return Fu(i) && wm(a) ? Cm(hn(i), a) : function(l) {
                            var d = qu(l, i);
                    ...
                    function jo(i, a, l, d, v) {
                        i !== a && gu(a, function(E, $) {
                            if (v || (v = new Jr), wt(E)) J1(i, a, $, l, jo, d, v);
                            else {
                    ...
                    function J1(i, a, l, d, v, E, $) {
                        ...
                        if (ne) {
                            var me = Fe(x),
                                Oe = !me && Xn(x),
                                Re = !me && !Oe && bs(x);
                            Z = x, me || Oe || Re ? Fe(R) ? Z = R : At(R) ? Z = gr(R) : Oe ? (ne = !1, Z = sm(x, !0)) : Re ? (ne = !1, Z = am(x, !0)) : Z = [] : wa(x) || Pi(x) ? (Z = R, Pi(R) ? Z = rv(R) : (!wt(R) || Nn(R)) && (Z = Om(x))) : ne = !1
                        }
                    ...
                    function qg(i, a) {
                        var l = i.length;
                        if (!!l) return a += a < 0 ? l : 0, Rn(a, l) ? i[a] : r
                    }
                    ...
                    function ba(i, a, l, d) {
                        ...
                        for (var v = -1, E = a.length, $ = E - 1, R = i; R != null && ++v < E;) {
                            ...
                            if (v != $) {
                                var Z = R[x];
                                J = d ? d(Z, x, R) : r, J === r && (J = wt(Z) ? Z : Rn(a[v + 1]) ? [] : {})
                            }
                            va(R, x, J), R = R[x]
                        }
                        return i
                    }
                    var Zg = xo ? function(i, a) {
                            return xo.set(i, a), i
                        } : yr,
                        nC = Po ? function(i, a) {
                    ...
                    function Cu(i, a) {
                        return a = qn(a, i), i = $m(i, a), i == null || delete i[hn(jr(a))]
                    }
                    ...
                    function qn(i, a) {
                        return Fe(i) ? i : Fu(i, a) ? [i] : Pm(st(i))
                    }
                    var aC = Ke;
                    ...
                    function _s(i) {
                        return function(a) {
                            return tu(uv(lv(a).replace(n0, "")), i, "")
                        }
                    }
                    ...
                    function pC(i, a, l) {
                        ...
                        function v() {
                            ...
                            var J = E < 3 && $[0] !== x && $[E - 1] !== x ? [] : Kn($, x);
                            if (E -= J.length, E < l) return vm(i, a, Ho, v.placeholder, r, $, J, r, r, l - E);
                    ...
                    function Ho(i, a, l, d, v, E, $, R, x, J) {
                        ...
                        function Ne() {
                            ...
                            if (Oe) var ur = Es(Ne),
                                Ar = C0(Ye, ur);
                            if (d && (Ye = cm(Ye, d, v, Oe)), E && (Ye = lm(Ye, E, $, Oe)), He -= Ar, Oe && He < J) {
                                var Rt = Kn(Ye, ur);
                                return vm(i, a, Ho, Ne.placeholder, l, Ye, Rt, R, x, J - He)
                            }
                            var Qr = ne ? l : this,
                                Ln = me ? Qr[i] : i;
                            return He = Ye.length, R ? Ye = kC(Ye, R) : Re && He > 1 && Ye.reverse(), Z && x < He && (Ye.length = x), this && this !== qt && this instanceof Ne && (Ln = Ge || Ta(Ln)), Ln.apply(Qr, Ye)
                        }
                        return Ne
                    }
                    ...
                    function Vo(i, a) {
                        return function(l, d) {
                            ...
                            if (l !== r && (v = l), d !== r) {
                                if (v === r) return d;
                                typeof l == "string" || typeof d == "string" ? (l = Cr(l), d = Cr(d)) : (l = em(l), d = em(d)), v = i(l, d)
                            }
                            return v
                        }
                    }
                    ...
                    function Yo(i, a) {
                        ...
                        return fs(a) ? zn(Xr(d), 0, i).join("") : d.slice(0, i)
                    }
                    ...
                    function mm(i) {
                        return function(a, l, d) {
                            return d && typeof d != "number" && lr(a, l, d) && (l = d = r), a = Pn(a), l === r ? (l = a, a = 0) : l = Pn(l), d = d === r ? a < l ? 1 : -1 : Pn(d), eC(a, l, d, i)
                        }
                    }
                    ...
                    function vm(i, a, l, d, v, E, $, R, x, J) {
                        ...
                        var Ge = [i, a, v, Oe, ne, Re, me, R, x, J],
                            Ne = l.apply(r, Ge);
                        return Uu(i) && Am(Ne, Ge), Ne.placeholder = d, Rm(Ne, i, a)
                    }

                    function Pu(i) {
                        var a = Mt[i];
                        return function(l, d) {
                            if (l = Gr(l), d = d == null ? 0 : rr(Be(d), 292), d && Rg(l)) {
                    ...
                    function Em(i, a, l, d, v, E) {
                        return wt(i) && wt(a) && (E.set(a, i), jo(i, a, r, Em, E), E.delete(a)), i
                    }
                    ...
                    function Ae() {
                        var i = y.iteratee || Zu;
                        return i = i === Zu ? Kg : i, arguments.length ? i(arguments[0], arguments[1]) : i
                    }
                    ...
                    var Mu = uu ? function(i) {
                            return i == null ? [] : (i = ut(i), Gn(uu(i), function(a) {
                                return $g.call(i, a)
                            }))
                        } : tf,
                        Tm = uu ? function(i) {
                            for (var a = []; i;) Wn(a, Mu(i)), i = Ro(i);
                            return a
                        } : tf,
                        nr = cr;
                    ...
                    function Sm(i, a, l) {
                        ...
                        return E || ++d != v ? E : (v = i == null ? 0 : i.length, !!v && nc(v) && Rn($, v) && (Fe(i) || Pi(i)))
                    }
...
`)
                    ...
                    function lr(i, a, l) {
                        if (!wt(l)) return !1;
                        var d = typeof a;
                        return (d == "number" ? mr(l) && Rn(a, l.length) : d == "string" && a in l) ? Zr(l[a], i) : !1
                    }
                    ...
                    function NC(i, a) {
                        ...
                        if (R) {
                            var x = i[3];
                            i[3] = x ? cm(x, R, a[4]) : R, i[4] = x ? Kn(i[3], m) : a[4]
                        }
                        return R = a[5], R && (x = i[5], i[5] = x ? lm(x, R, a[6]) : R, i[6] = x ? Kn(i[5], m) : a[6]), R = a[7], R && (i[7] = R), d & ie && (i[8] = i[8] == null ? a[8] : rr(i[8], a[8])), i[9] == null && (i[9] = a[9]), i[0] = a[0], i[1] = v, i
                    }
                    ...
                    function rI(i, a, l) {
                        ...
                        if (!d) return -1;
                        var v = d;
                        return l !== r && (v = Be(l), v = v < 0 ? Ft(d + v, 0) : rr(v, d - 1)), a === a ? x0(i, a, v) : To(i, vg, v, !0)
                    }

                    function nI(i, a) {
                        return i && i.length ? qg(i, Be(a)) : r
                    }
                    var iI = Ke(Fm);
                    ...
                    var oI = An(function(i, a) {
                        var l = i == null ? 0 : i.length,
                            d = pu(i, a);
                        return Jg(i, bt(a, function(v) {
                            return Rn(v, l) ? +v : v
                        }).sort(om)), d
                    });
                    ...
                    var SI = Ke(function(i) {
                            return Yn(zt(i, 1, At, !0))
                        }),
                        OI = Ke(function(i) {
                            var a = jr(i);
                            return At(a) && (a = r), Yn(zt(i, 1, At, !0), Ae(a, 2))
                        }),
                        wI = Ke(function(i) {
                            var a = jr(i);
                            return a = typeof a == "function" ? a : r, Yn(zt(i, 1, At, !0), r, a)
                        });
                    ...
                    var AI = Ke(function(i, a) {
                        ...
                        NI = Ke(function(i) {
                            var a = jr(i);
                            return At(a) && (a = r), Iu(Gn(i, At), Ae(a, 2))
                        }),
                        PI = Ke(function(i) {
                            var a = jr(i);
                            return a = typeof a == "function" ? a : r, Iu(Gn(i, At), r, a)
                        }),
                        LI = Ke(Wu);
                    ...
                    var FI = An(function(i) {
                        ...
                        return a > 1 || this.__actions__.length || !(d instanceof Ve) || !Rn(l) ? this.thru(v) : (d = d.slice(l, +l + (a ? 1 : 0)), d.__actions__.push({
                            func: Zo,
                            args: [v],
                            thisArg: r
                    ...
                    var e$ = Ko(function(i, a, l) {
                        ct.call(i, l) ? i[l].push(a) : In(i, l, [a])
                    });
                    ...
                    function i$(i, a, l, d) {
                        return i == null ? [] : (Fe(a) || (a = a == null ? [] : [a]), l = d ? r : l, Fe(l) || (l = l == null ? [] : [l]), zg(i, a, l))
                    }
                    ...
                    function a$(i, a, l) {
                        ...
                        return d(i, Ae(a, 4), l, v, Vn)
                    }

                    function o$(i, a, l) {
                        var d = Fe(i) ? _0 : _g,
                            v = arguments.length < 3;
                        return d(i, Ae(a, 4), l, v, Fg)
                    }
                    ...
                    var p$ = Ke(function(i, a) {
                            if (i == null) return [];
                            var l = a.length;
                            return l > 1 && lr(i, a[0], a[1]) ? a = [] : l > 2 && lr(a[0], a[1], a[2]) && (a = [a[0]]), zg(i, zt(a, 1), [])
                        }),
                        ec = q0 || function() {
                            return qt.Date.now()
                        };
                    ...
                    function Wm(i, a, l) {
                        return a = l ? r : a, a = i && a == null ? i.length : a, $n(i, ie, r, r, r, r, a)
                    }
                    ...
                    function Vm(i, a, l) {
                        a = l ? r : a;
                        var d = $n(i, Y, r, r, r, r, r, a);
                        return d.placeholder = Vm.placeholder, d
                    }

                    function Ym(i, a, l) {
                        a = l ? r : a;
                        var d = $n(i, G, r, r, r, r, r, a);
                    ...
                    function qm(i, a, l) {
                        var d, v, E, $, R, x, J = 0,
                            ...
                            me = !0;
                        if (typeof i != "function") throw new Mr(c);
                        a = Gr(a) || 0, wt(l) && (Z = !!l.leading, ne = "maxWait" in l, E = ne ? Ft(Gr(l.maxWait) || 0, a) : E, me = "trailing" in l ? !!l.trailing : me);

                        function Oe(Rt) {
                            var Qr = d,
                                Ln = v;
                            return d = v = r, J = Rt, $ = i.apply(Ln, Qr), $
                        }
                        ...
                        function Ge(Rt) {
                            var Qr = Rt - x,
                                Ln = Rt - J,
                                hv = a - Qr;
                            return ne ? rr(hv, E - Ln) : hv
                        }

                        function Ne(Rt) {
                            var Qr = Rt - x,
                                Ln = Rt - J;
                            return x === r || Qr >= a || Qr < 0 || ne && Ln >= E
                        }
                        ...
                        function Ar() {
                            ...
                            if (d = arguments, v = this, x = Rt, Qr) {
                                if (R === r) return Re(x);
                                if (ne) return im(R), R = Oa(He, a), Oe(x)
                            }
                    ...
                    function tc(i, a) {
                        ...
                        return l.cache = new(tc.Cache || Cn), l
                    }
                    tc.Cache = Cn;
                    ...
                    function O$(i, a, l) {
                        var d = !0,
                            v = !0;
                        if (typeof i != "function") throw new Mr(c);
                        return wt(l) && (d = "leading" in l ? !!l.leading : d, v = "trailing" in l ? !!l.trailing : v), qm(i, a, {
                            leading: d,
                            maxWait: a,
                            trailing: v
                        })
                    ...
                    var L$ = qo(vu),
                        ...
                        Pi = Gg(function() {
                            ...
                            return It(i) && ct.call(i, "callee") && !$g.call(i, "callee")
                        },
                        Fe = H.isArray,
                        x$ = lg ? wr(lg) : W1;

                    function mr(i) {
                        return i != null && nc(i.length) && !Nn(i)
                    }
                    ...
                    function D$(i) {
                        return i === !0 || i === !1 || It(i) && cr(i) == Et
                    }
                    var Xn = X0 || rf,
                        M$ = ug ? wr(ug) : K1;

                    function F$(i) {
                        return It(i) && i.nodeType === 1 && !wa(i)
                    }

                    function U$(i) {
                        if (i == null) return !0;
                        if (mr(i) && (Fe(i) || typeof i == "string" || typeof i.splice == "function" || Xn(i) || bs(i) || Pi(i))) return !i.length;
                        var a = nr(i);
                    ...
                    function Zm(i) {
                        return typeof i == "number" || It(i) && cr(i) == O
                    }

                    function wa(i) {
                        if (!It(i) || cr(i) != U) return !1;
                        var a = Ro(i);
                        if (a === null) return !0;
                    ...
                    function ic(i) {
                        return typeof i == "string" || !Fe(i) && It(i) && cr(i) == A
                    }

                    function Ir(i) {
                        return typeof i == "symbol" || It(i) && cr(i) == W
                    }
                    var bs = pg ? wr(pg) : z1;
                    ...
                    var aA = Ke(function(i, a) {
                        ...
                        oA = Ke(function(i) {
                            return i.push(r, Em), Or(iv, r, i)
                        });

                    function cA(i, a) {
                        return mg(i, Ae(a, 3), fn)
                    }

                    function lA(i, a) {
                        return mg(i, Ae(a, 3), mu)
                    }
                    ...
                    function fA(i, a) {
                        return i == null ? i : Bg(i, Ae(a, 3), vr)
                    }
                    ...
                    function mA(i, a) {
                        return i != null && Sm(i, a, U1)
                    }

                    function zu(i, a) {
                        return i != null && Sm(i, a, B1)
                    }
                    var vA = gm(function(i, a, l) {
                            a != null && typeof a.toString != "function" && (a = Io.call(a)), i[a] = l
                        }, Ju(yr)),
                        yA = gm(function(i, a, l) {
                            a != null && typeof a.toString != "function" && (a = Io.call(a)), ct.call(i, a) ? i[a].push(l) : i[a] = [l]
                        }, Ae),
                        _A = Ke(_a);

                    function Kt(i) {
                        return mr(i) ? Lg(i) : Eu(i)
                    }

                    function vr(i) {
                        return mr(i) ? Lg(i, !0) : X1(i)
                    }
                    ...
                    function sv(i, a) {
                        ...
                        return a = Ae(a), Xg(i, l, function(d, v) {
                            return a(d, v[0])
                        })
                    }
                    ...
                    function AA(i, a, l) {
                        ...
                        if (a = Ae(a, 4), l == null) {
                            ...
                            v ? l = d ? new E : [] : wt(i) ? l = Nn(E) ? vs(Ro(i)) : {} : l = {}
                        }
                    ...
                    function NA(i, a, l) {
                        return i == null ? i : tm(i, a, Au(l))
                    }

                    function PA(i, a, l, d) {
                        return d = typeof d == "function" ? d : r, i == null ? i : tm(i, a, Au(l), d)
                    }
                    ...
                    function xA(i, a, l) {
                        return a = Pn(a), l === r ? (l = a, a = 0) : l = Pn(l), i = Gr(i), j1(i, a, l)
                    }

                    function DA(i, a, l) {
                        if (l && typeof l != "boolean" && lr(i, a, l) && (a = l = r), l === r && (typeof a == "boolean" ? (l = a, a = r) : typeof i == "boolean" && (l = i, i = r)), i === r && a === r ? (i = 0, a = 1) : (i = Pn(i), a === r ? (a = i, i = 0) : a = Pn(a)), i > a) {
                            var d = i;
                            i = a, a = d
                        }
                        if (l || i % 1 || a % 1) {
                    ...
                    var MA = _s(function(i, a, l) {
                        return a = a.toLowerCase(), i + (l ? cv(a) : a)
                    });
                    ...
                    function UA(i) {
                        return i = st(i), i && _w.test(i) ? i.replace(Bp, $0) : i
                    }
                    ...
                    function JA(i, a, l) {
                        return l && typeof l != "number" && lr(i, a, l) && (a = l = r), l = l === r ? Ue : l >>> 0, l ? (i = st(i), i && (typeof a == "string" || a != null && !Yu(a)) && (a = Cr(a), !a && fs(i)) ? zn(Xr(i), 0, l) : i.split(a, l)) : []
                    }
                    ...
                    function eR(i, a, l) {
                        ...
                        l && lr(i, a, l) && (a = r), i = st(i), a = sc({}, a, d, _m);
                        var v = sc({}, a.imports, d.imports, _m),
                            E = Kt(v),
                            $ = ou(v, E),
                            R, x, J = 0,
                            Z = a.interpolate || yo,
                            ne = "__p += '",
                            me = lu((a.escape || yo).source + "|" + Z.source + "|" + (Z === jp ? Lw : yo).source + "|" + (a.evaluate || yo).source + "|$", "g"),
...
`) + ne + `return __p
                    ...
                    function iR(i, a, l) {
                        if (i = st(i), i && (l || a === r)) return i.slice(0, Og(i) + 1);
                        if (!i || !(a = Cr(a))) return i;
                        var d = Xr(i),
                            v = Tg(d, Xr(a)) + 1;
                    ...
                    function aR(i, a) {
                        ...
                        var R = l - ds(d);
                        if (R < 1) return d;
                        var x = $ ? zn($, 0, R).join("") : i.slice(0, R);
                        if (v === r) return x + d;
                        if ($ && (R += x.length - R), Yu(v)) {
                            if (i.slice(R).search(v)) {
                                var J, Z = x;
                                for (v.global || (v = lu(v.source, st(Gp.exec(v)) + "g")), v.lastIndex = 0; J = v.exec(Z);) var ne = J.index;
                    ...
                    function oR(i) {
                        return i = st(i), i && yw.test(i) ? i.replace(Up, D0) : i
                    }
                    ...
                    function Zu(i) {
                        return Kg(typeof i == "function" ? i : Ur(i, _))
                    }
                    ...
                    function Qu(i, a, l) {
                        var d = Kt(a),
                            v = Bo(a, d);
                        l == null && !(wt(a) && (v.length || !d.length)) && (l = a, a = i, i = this, v = Bo(a, Kt(a)));
                        var E = !(wt(l) && "chain" in l) || !!l.chain,
                            $ = Nn(i);
                    ...
                    function NR(i) {
                        return Fe(i) ? bt(i, hn) : Ir(i) ? [i] : gr(Pm(st(i)))
                    }
                    ...
                    return y.after = g$, y.ary = Wm, y.assign = rA, y.assignIn = nv, y.assignInWith = sc, y.assignWith = nA, y.at = iA, y.before = Km, y.bind = Ku, y.bindAll = lR, y.bindKey = Hm, y.castArray = I$, y.chain = Bm, y.chunk = DC, y.compact = MC, y.concat = FC, y.cond = uR, y.conforms = fR, y.constant = Ju, y.countBy = VI, y.create = sA, y.curry = Vm, y.curryRight = Ym, y.debounce = qm, y.defaults = aA, y.defaultsDeep = oA, y.defer = m$, y.delay = v$, y.difference = UC, y.differenceBy = BC, y.differenceWith = jC, y.drop = GC, y.dropRight = WC, y.dropRightWhile = KC, y.dropWhile = HC, y.fill = VC, y.filter = qI, y.flatMap = JI, y.flatMapDeep = ZI, y.flatMapDepth = QI, y.flatten = Dm, y.flattenDeep = YC, y.flattenDepth = qC, y.flip = y$, y.flow = hR, y.flowRight = pR, y.fromPairs = zC, y.functions = pA, y.functionsIn = gA, y.groupBy = e$, y.initial = JC, y.intersection = ZC, y.intersectionBy = QC, y.intersectionWith = eI, y.invert = vA, y.invertBy = yA, y.invokeMap = r$, y.iteratee = Zu, y.keyBy = n$, y.keys = Kt, y.keysIn = vr, y.map = Qo, y.mapKeys = EA, y.mapValues = bA, y.matches = gR, y.matchesProperty = mR, y.memoize = tc, y.merge = TA, y.mergeWith = iv, y.method = vR, y.methodOf = yR, y.mixin = Qu, y.negate = rc, y.nthArg = ER, y.omit = SA, y.omitBy = OA, y.once = _$, y.orderBy = i$, y.over = bR, y.overArgs = E$, y.overEvery = TR, y.overSome = SR, y.partial = Hu, y.partialRight = zm, y.partition = s$, y.pick = wA, y.pickBy = sv, y.property = dv, y.propertyOf = OR, y.pull = iI, y.pullAll = Fm, y.pullAllBy = sI, y.pullAllWith = aI, y.pullAt = oI, y.range = wR, y.rangeRight = CR, y.rearg = b$, y.reject = c$, y.remove = cI, y.rest = T$, y.reverse = Gu, y.sampleSize = u$, y.set = IA, y.setWith = $A, y.shuffle = f$, y.slice = lI, y.sortBy = p$, y.sortedUniq = mI, y.sortedUniqBy = vI, y.split = JA, y.spread = S$, y.tail = yI, y.take = _I, y.takeRight = EI, y.takeRightWhile = bI, y.takeWhile = TI, y.tap = MI, y.throttle = O$, y.thru = Zo, y.toArray = ev, y.toPairs = av, y.toPairsIn = ov, y.toPath = NR, y.toPlainObject = rv, y.transform = AA, y.unary = w$, y.union = SI, y.unionBy = OI, y.unionWith = wI, y.uniq = CI, y.uniqBy = II, y.uniqWith = $I, y.unset = RA, y.unzip = Wu, y.unzipWith = Um, y.update = NA, y.updateWith = PA, y.values = Ts, y.valuesIn = LA, y.without = AI, y.words = uv, y.wrap = C$, y.xor = RI, y.xorBy = NI, y.xorWith = PI, y.zip = LI, y.zipObject = kI, y.zipObjectDeep = xI, y.zipWith = DI, y.entries = av, y.entriesIn = ov, y.extend = nv, y.extendWith = sc, Qu(y, y), y.add = LR, y.attempt = fv, y.camelCase = MA, y.capitalize = cv, y.ceil = kR, y.clamp = kA, y.clone = $$, y.cloneDeep = R$, y.cloneDeepWith = N$, y.cloneWith = A$, y.conformsTo = P$, y.deburr = lv, y.defaultTo = dR, y.divide = xR, y.endsWith = FA, y.eq = Zr, y.escape = UA, y.escapeRegExp = BA, y.every = YI, y.find = zI, y.findIndex = km, y.findKey = cA, y.findLast = XI, y.findLastIndex = xm, y.findLastKey = lA, y.floor = DR, y.forEach = jm, y.forEachRight = Gm, y.forIn = uA, y.forInRight = fA, y.forOwn = dA, y.forOwnRight = hA, y.get = qu, y.gt = L$, y.gte = k$, y.has = mA, y.hasIn = zu, y.head = Mm, y.identity = yr, y.includes = t$, y.indexOf = XC, y.inRange = xA, y.invoke = _A, y.isArguments = Pi, y.isArray = Fe, y.isArrayBuffer = x$, y.isArrayLike = mr, y.isArrayLikeObject = At, y.isBoolean = D$, y.isBuffer = Xn, y.isDate = M$, y.isElement = F$, y.isEmpty = U$, y.isEqual = B$, y.isEqualWith = j$, y.isError = Vu, y.isFinite = G$, y.isFunction = Nn, y.isInteger = Xm, y.isLength = nc, y.isMap = Jm, y.isMatch = W$, y.isMatchWith = K$, y.isNaN = H$, y.isNative = V$, y.isNil = q$, y.isNull = Y$, y.isNumber = Zm, y.isObject = wt, y.isObjectLike = It, y.isPlainObject = wa, y.isRegExp = Yu, y.isSafeInteger = z$, y.isSet = Qm, y.isString = ic, y.isSymbol = Ir, y.isTypedArray = bs, y.isUndefined = X$, y.isWeakMap = J$, y.isWeakSet = Z$, y.join = tI, y.kebabCase = jA, y.last = jr, y.lastIndexOf = rI, y.lowerCase = GA, y.lowerFirst = WA, y.lt = Q$, y.lte = eA, y.max = MR, y.maxBy = FR, y.mean = UR, y.meanBy = BR, y.min = jR, y.minBy = GR, y.stubArray = tf, y.stubFalse = rf, y.stubObject = IR, y.stubString = $R, y.stubTrue = AR, y.multiply = WR, y.nth = nI, y.noConflict = _R, y.noop = ef, y.now = ec, y.pad = KA, y.padEnd = HA, y.padStart = VA, y.parseInt = YA, y.random = DA, y.reduce = a$, y.reduceRight = o$, y.repeat = qA, y.replace = zA, y.result = CA, y.round = KR, y.runInContext = k, y.sample = l$, y.size = d$, y.snakeCase = XA, y.some = h$, y.sortedIndex = uI, y.sortedIndexBy = fI, y.sortedIndexOf = dI, y.sortedLastIndex = hI, y.sortedLastIndexBy = pI, y.sortedLastIndexOf = gI, y.startCase = ZA, y.startsWith = QA, y.subtract = HR, y.sum = VR, y.sumBy = YR, y.template = eR, y.times = RR, y.toFinite = Pn, y.toInteger = Be, y.toLength = tv, y.toLower = tR, y.toNumber = Gr, y.toSafeInteger = tA, y.toString = st, y.toUpper = rR, y.trim = nR, y.trimEnd = iR, y.trimStart = sR, y.truncate = aR, y.unescape = oR, y.uniqueId = PR, y.upperCase = cR, y.upperFirst = Xu, y.each = jm, y.eachRight = Gm, y.first = Mm, Qu(y, function() {
                        var i = {};
    ...
    function X3(t, e, r, n, s, o) {
        ...
        }, null, 10, V3)) : We("", !0), t.player.hasControls ? (se(), le($t, {
            key: 1
        ...
        }, null, 10, q3)) : We("", !0)], 64)) : t.player.gamepadStart ? (se(), le($t, {
            key: 2
        }, [t.player.status === "waitingForMore" ? (se(), le("p", {
            key: 0,
            class: qe(t.localClasses.status)
    ...
    function iK(t, e, r, n, s, o) {
        ...
        ]) : We("", !0), t.player.hasControls ? (se(), le($t, {
            key: 1
    ...
    typeof window > "u" || typeof window.getComputedStyle != "function" ? ((Pa = function(t) {
        ...
        return t && Array.prototype.forEach.call(t.length ? t : [t], gK), t
    }, Pa.update = function(t) {
        return t && Array.prototype.forEach.call(t.length ? t : [t], mK), t
    });
    var vK = Pa,
        yK = {
            exports: {}
    ...
    var wS = function(t, e) {
        ...
        NK = $K(function() {
            ...
            return AK(t) == "String" ? RK(t, "") : Sf(t)
        } : Sf,
        PK = TypeError,
        lo = function(t) {
            if (t == null) throw PK("Can't call method on " + t);
            return t
        },
        LK = NK,
        kK = lo,
        ...
        xK = Tr,
        oa = function(t) {
            return typeof t == "object" ? t !== null : xK(t)
        },
        Of = Lr,
        DK = Tr,
        MK = function(t) {
        ...
        $l = function(t, e) {
            return arguments.length < 2 ? MK(Of[t]) : Of[t] && Of[t][e]
        },
        FK = or,
        AS = FK({}.isPrototypeOf),
        UK = $l,
        BK = UK("navigator", "userAgent") || "",
        RS = Lr,
        wf = BK,
        jy = RS.process,
        Gy = RS.Deno,
        ...
        Ky = Wy && Wy.v8,
        en, Yc;
    Ky && (en = Ky.split("."), Yc = en[0] > 0 && en[0] < 4 ? 1 : +(en[0] + en[1]));
    !Yc && wf && (en = wf.match(/Edge\/(\d+)/), (!en || en[1] >= 74) && (en = wf.match(/Chrome\/(\d+)/), en && (Yc = +en[1])));
    var jK = Yc,
        Hy = jK,
        GK = kr,
        NS = !!Object.getOwnPropertySymbols && !GK(function() {
            var t = Symbol();
            return !String(t) || !(Object(t) instanceof Symbol) || !Symbol.sham && Hy && Hy < 41
        }),
        WK = NS,
        PS = WK && !Symbol.sham && typeof Symbol.iterator == "symbol",
        KK = $l,
        HK = Tr,
        VK = AS,
        YK = PS,
        ...
        LS = YK ? function(t) {
            ...
            var e = KK("Symbol");
            return HK(e) && VK(e.prototype, qK(t))
        },
        zK = String,
        XK = function(t) {
            try {
        ...
        e8 = function(t) {
            if (JK(t)) return t;
            throw QK(ZK(t) + " is not a function")
        },
        t8 = e8,
        sp = function(t, e) {
            var r = t[e];
            return r == null ? void 0 : t8(r)
        },
        Cf = _i,
        If = Tr,
        $f = oa,
    ...
    var c8 = lo,
        ...
        m8 = h8(1 .toString),
        xS = function(t) {
            return "Symbol(" + (t === void 0 ? "" : t) + ")_" + m8(++p8 + g8, 36)
        },
        v8 = Lr,
        y8 = Al.exports,
        zy = Ei,
        ...
        ts = v8.Symbol,
        Jy = ts && ts.for,
        E8 = DS ? ts : ts && ts.withoutSetter || _8,
        os = function(t) {
            if (!zy(Os, t) || !(Xy || typeof Os[t] == "string")) {
                var e = "Symbol." + t;
                Xy && zy(ts, t) ? Os[t] = ts[t] : DS && Jy ? Os[t] = Jy(e) : Os[t] = E8(e)
            }
            return Os[t]
        },
        b8 = _i,
        ...
        C8 = O8("toPrimitive"),
        I8 = function(t, e) {
            if (!Zy(t) || Qy(t)) return t;
            var r = T8(t, C8),
                n;
            if (r) {
                if (e === void 0 && (e = "default"), n = b8(r, t, e), !Zy(n) || Qy(n)) return n;
                throw w8("Can't convert object to primitive value")
            }
            return e === void 0 && (e = "number"), S8(t, e)
        },
        $8 = I8,
        A8 = LS,
        MS = function(t) {
        ...
        e_ = oa,
        Cd = R8.document,
        N8 = e_(Cd) && e_(Cd.createElement),
        FS = function(t) {
            return N8 ? Cd.createElement(t) : {}
        },
        P8 = yi,
        L8 = kr,
        k8 = FS,
        US = !P8 && !L8(function() {
            return Object.defineProperty(k8("div"), "a", {
                get: function() {
                    return 7
                }
            }).a != 7
    ...
    np.f = x8 ? t_ : function(e, r) {
        if (e = U8(e), r = B8(r), G8) try {
            return t_(e, r)
        } catch {}
        if (j8(e, r)) return F8(!D8(M8.f, e, r), e[r])
    };
    var uo = {},
        W8 = yi,
        K8 = kr,
        ...
        cs = function(t) {
            if (H8(t)) return t;
            throw Y8(V8(t) + " is not an object")
        },
        q8 = yi,
        z8 = US,
        X8 = BS,
        ...
        Nf = "configurable",
        Pf = "writable";
    uo.f = q8 ? X8 ? function(e, r, n) {
        if (vc(e), r = r_(r), vc(n), typeof e == "function" && r === "prototype" && "value" in n && Pf in n && !n[Pf]) {
            var s = Z8(e, r);
        ...
        if (vc(e), r = r_(r), vc(n), z8) try {
            return Af(e, r, n)
        } catch {}
        if ("get" in n || "set" in n) throw J8("Accessors not supported");
        return "value" in n && (e[r] = n.value), e
    };
    var Q8 = yi,
        eH = uo,
        tH = wS,
        cp = Q8 ? function(t, e, r) {
            return eH.f(t, e, tH(1, r))
        } : function(t, e, r) {
            return t[e] = r, t
        },
        jS = {
        ...
        nH = Id && Object.getOwnPropertyDescriptor,
        lp = rH(GS, "name"),
        iH = lp && function() {}.name === "something",
        sH = lp && (!Id || Id && nH(GS, "name").configurable),
        aH = {
            EXISTS: lp,
            PROPER: iH,
            CONFIGURABLE: sH
        ...
        cH = Tr,
        $d = op,
        lH = oH(Function.toString);
    cH($d.inspectSource) || ($d.inspectSource = function(t) {
        return lH(t)
    });
    var WS = $d.inspectSource,
        ...
        dH = WS,
        n_ = uH.WeakMap,
        hH = fH(n_) && /native code/.test(dH(n_)),
        pH = Al.exports,
        gH = xS,
        i_ = pH("keys"),
        KS = function(t) {
            return i_[t] || (i_[t] = gH(t))
        },
        up = {},
        mH = hH,
        HS = Lr,
        ...
        Ad = HS.TypeError,
        bH = HS.WeakMap,
        qc, Qa, zc, TH = function(t) {
            return zc(t) ? Qa(t) : qc(t, {})
        },
        SH = function(t) {
            return function(e) {
                var r;
                if (!vH(e) || (r = Qa(e)).type !== t) throw Ad("Incompatible receiver, " + t + " required");
                return r
            }
        };
    if (mH || xf.state) {
        var Fi = xf.state || (xf.state = new bH),
            OH = Lf(Fi.get),
            a_ = Lf(Fi.has),
            wH = Lf(Fi.set);
        qc = function(t, e) {
            if (a_(Fi, t)) throw new Ad(s_);
            return e.facade = t, wH(Fi, t, e), e
        }, Qa = function(t) {
            return OH(Fi, t) || {}
        }, zc = function(t) {
            return a_(Fi, t)
        ...
        var ws = _H("state");
        EH[ws] = !0, qc = function(t, e) {
            if (kf(t, ws)) throw new Ad(s_);
            return e.facade = t, yH(t, ws, e), e
        }, Qa = function(t) {
            return kf(t, ws) ? t[ws] : {}
        }, zc = function(t) {
            return kf(t, ws)
    ...
    var VS = {
        ...
        kH = jS.exports = function(t, e, r) {
            String(e).slice(0, 7) === "Symbol(" && (e = "[" + String(e).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), r && r.getter && (e = "get " + e), r && r.setter && (e = "set " + e), (!yc(t, "name") || $H && t.name !== e) && (Rd ? Rc(t, "name", {
                value: e,
                configurable: !0
            }) : t.name = e), PH && r && yc(r, "arity") && t.length !== r.arity && Rc(t, "length", {
                value: r.arity
            });
            try {
            ...
            var n = RH(t);
            return yc(n, "source") || (n.source = LH.join(typeof e == "string" ? e : "")), t
        };
    Function.prototype.toString = kH(function() {
        return IH(this) && NH(this).source || AH(this)
    }, "toString");
    var xH = Tr,
        DH = uo,
        MH = jS.exports,
        ...
        qS = function(t, e, r, n) {
            ...
            if (xH(r) && MH(r, o, n), n.global) s ? t[e] = r : FH(e, r);
            else {
                try {
        ...
        VH = function(t, e) {
            var r = WH(t);
            return r < 0 ? KH(r + e, 0) : HH(r, e)
        },
        YH = Rl,
        qH = Math.min,
        XS = function(t) {
            return t > 0 ? qH(YH(t), 9007199254740991) : 0
        },
        zH = XS,
        XH = function(t) {
            return zH(t.length)
        ...
        JS = function(t, e) {
            var r = rV(t),
                ...
                s = [],
                o;
            for (o in r) !Df(iV, o) && Df(r, o) && c_(s, o);
            for (; e.length > n;) Df(r, o = e[n++]) && (~nV(s, o) || c_(s, o));
            return s
        },
        fp = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"],
        sV = JS,
        aV = fp,
        oV = aV.concat("length", "prototype");
    ...
    var cV = $l,
        ...
        dV = cs,
        hV = lV([].concat),
        pV = cV("Reflect", "ownKeys") || function(e) {
            var r = uV.f(dV(e)),
                n = fV.f;
            return n ? hV(r, n(e)) : r
        },
        ...
        vV = uo,
        yV = function(t, e, r) {
            for (var n = gV(e), s = vV.f, o = mV.f, c = 0; c < n.length; c++) {
                var u = n[c];
                !l_(t, u) && !(r && l_(r, u)) && s(t, u, o(e, u))
            }
        },
        _V = kr,
        EV = Tr,
        ...
        fo = function(t, e) {
            var r = SV[TV(t)];
            return r == wV ? !0 : r == OV ? !1 : EV(e) ? _V(e) : !!e
        },
        TV = fo.normalize = function(t) {
            return String(t).replace(bV, ".").toLowerCase()
        },
        SV = fo.data = {},
        OV = fo.NATIVE = "N",
        wV = fo.POLYFILL = "P",
        ...
        QS = function(t, e) {
            var r = t.target,
                ...
                s = t.stat,
                o, c, u, f, h, m;
            if (n ? c = Mf : s ? c = Mf[r] || RV(r, {}) : c = (Mf[r] || {}).prototype, c)
                for (u in e) {
                    if (h = e[u], t.dontCallGetSet ? (m = IV(c, u), f = m && m.value) : f = c[u], o = PV(n ? u : r + (s ? "." : "#") + u, t.forced), !o && f !== void 0) {
                        if (typeof h == typeof f) continue;
                        NV(h, f)
                    }(t.sham || f && f.sham) && $V(h, "sham", !0), AV(c, u, h, t)
                }
        },
        LV = oa,
        kV = Cl,
        ...
        MV = function(t) {
            var e;
            return LV(t) && ((e = t[DV]) !== void 0 ? !!e : kV(t) == "RegExp")
        },
        FV = os,
        UV = FV("toStringTag"),
        eO = {};
    eO[UV] = "z";
    var BV = String(eO) === "[object z]",
        jV = BV,
        GV = Tr,
        Nc = Cl,
        WV = os,
        ...
        qV = jV ? Nc : function(t) {
            var e, r, n;
            return t === void 0 ? "Undefined" : t === null ? "Null" : typeof(r = YV(e = HV(t), KV)) == "string" ? r : VV ? Nc(e) : (n = Nc(e)) == "Object" && GV(e.callee) ? "Arguments" : n
        },
        zV = qV,
        XV = String,
        Nl = function(t) {
            if (zV(t) === "Symbol") throw TypeError("Cannot convert a Symbol value to a string");
            return XV(t)
        },
        JV = cs,
        tO = function() {
        ...
        r4 = function(t) {
            var e = t.flags;
            return e === void 0 && !("flags" in u_) && !QV(t, "flags") && e4(u_, t) ? ZV(t4, t) : e
        },
        dp = or,
        n4 = kS,
        i4 = Math.floor,
        ...
        rO = function(t, e, r, n, s, o) {
            var c = r + t.length,
                u = n.length,
                f = o4;
            return s !== void 0 && (s = n4(s), f = a4), s4(o, f, function(h, m) {
                var _;
                switch (Ff(m, 0)) {
                    case "$":
                        return "$";
    ...
    c4({
        ...
        replaceAll: function(e, r) {
            var n = f_(this),
                ...
                M = "";
            if (e != null) {
                if (s = f4(e), s && (o = Aa(f_(h4(e))), !~nO(o, "g"))) throw v4("`.replaceAll` does not allow non-global regexes");
                if (c = d4(e, m4), c) return l4(c, e, n, r)
            }
            for (u = Aa(n), f = Aa(e), h = u4(r), h || (r = Aa(r)), m = f.length, _ = y4(1, m), C = h_(u, f, 0); C !== -1;) b = h ? Aa(r(f, C, u)) : p4(f, u, C, [], void 0, r), M += d_(u, L, C) + b, L = C + m, C = h_(u, f, C + _);
            return L < u.length && (M += d_(u, L)), M
        }
    });
    var pp = kr,
        _4 = Lr,
        ...
        R4 = Il,
        N4 = w4;
    iO.f = C4 && !I4 ? Object.defineProperties : function(e, r) {
        A4(e);
        for (var n = R4(r), s = N4(r), o = s.length, c = 0, u; o > c;) $4.f(e, u = s[c++], n[u]);
        return e
    };
    var P4 = $l,
        L4 = P4("document", "documentElement"),
        k4 = cs,
        x4 = iO,
        p_ = fp,
        D4 = up,
        ...
        B4 = function() {
            var t = F4("iframe"),
                e = "java" + Pd + ":",
                r;
            return t.style.display = "none", M4.appendChild(t), t.src = String(e), r = t.contentWindow.document, r.open(), r.write(aO("document.F=Object")), r.close(), r.F
        },
        _c, Pc = function() {
            try {
                _c = new ActiveXObject("htmlfile")
            } catch {}
            Pc = typeof document < "u" ? document.domain && _c ? v_(_c) : B4() : v_(_c);
            for (var t = p_.length; t--;) delete Pc[Nd][p_[t]];
            return Pc()
        };
    D4[sO] = !0;
    var j4 = Object.create || function(e, r) {
            var n;
            return e !== null ? (Bf[Nd] = k4(e), n = new Bf, Bf[Nd] = null, n[sO] = e) : n = Pc(), r === void 0 ? n : x4.f(n, r)
        },
        G4 = kr,
        W4 = Lr,
        K4 = W4.RegExp,
...
`) && t.flags === "s")
        ...
        rY = H4,
        nY = z4,
        iY = Q4("native-string-replace", String.prototype.replace),
    ...
    cY && (Ld = function(e) {
        ...
        var C = n.groups,
            ...
            I = 0,
            K = s;
        if (L && (M = oY(M, "y", ""), aY(M, "g") === -1 && (M += "g"), K = jf(s, r.lastIndex), r.lastIndex > 0 && (!r.multiline || r.multiline && sY(s, r.lastIndex - 1) !== `
`) && (B = "(?: " + B + ")", K = " " + K, I++), u = new RegExp("^(?:" + B + ")", M)), xd && (u = new RegExp("^" + B + "$(?!\\s)", M)), kd && (f = r.lastIndex), h = As(Xc, L ? u : r, K), L ? h ? (h.input = jf(h.input, I), h[0] = jf(h[0], I), h.index = r.lastIndex, r.lastIndex += h[0].length) : r.lastIndex = 0 : kd && h && (r.lastIndex = r.global ? h.index + h[0].length : f), xd && h && h.length > 1 && As(iY, h[0], u, function() {
            ...
            for (h.groups = _ = eY(null), m = 0; m < C.length; m++) b = C[m], _[b[0]] = h[b[1]];
        return h
    });
    var vp = Ld,
        lY = QS,
    ...
    var uY = ip,
        ...
        __ = cO.apply,
        E_ = cO.call,
        fY = typeof Reflect == "object" && Reflect.apply || (uY ? E_.bind(__) : function() {
        ...
        gY = function(t, e, r, n) {
            var s = lO(t),
                ...
                c = o && !S_(function() {
                    var h = !1,
                        m = /a/;
                    return t === "split" && (m = {}, m.constructor = {}, m.constructor[pY] = function() {
                        return m
            ...
            if (!o || !c || r) {
                ...
                T_(String.prototype, t, f[0]), T_(Gf, s, f[1])
            }
            n && hY(Gf[s], "sham", !0)
        },
        yp = or,
        ...
        w_ = function(t) {
            return function(e, r) {
                var n = vY(yY(e)),
                    ...
                    o = n.length,
                    c, u;
                return s < 0 || s >= o ? t ? "" : void 0 : (c = O_(n, s), c < 55296 || c > 56319 || s + 1 === o || (u = O_(n, s + 1)) < 56320 || u > 57343 ? t ? _Y(n, s) : c : t ? EY(n, s, s + 2) : (c - 55296 << 10) + (u - 56320) + 65536)
            }
        },
        bY = {
            codeAt: w_(!1),
        ...
        AY = function(t, e) {
            ...
            if (wY(r)) {
                var n = C_(r, t, e);
                return n !== null && OY(n), n
            }
            if (CY(t) === "RegExp") return C_(IY, t, e);
            throw $Y("RegExp#exec called on incompatible receiver")
        },
        RY = fY,
        I_ = _i,
        Ll = or,
    ...
    NY("replace", function(t, e, r) {
        var n = R_ ? "$" : "$0";
        return [function(o, c) {
            var u = MY(this),
                f = o == null ? void 0 : UY(o, Dd);
            return f ? I_(f, o, u, c) : I_(e, Cs(u), o, c)
        }, function(s, o) {
            var c = LY(this),
                u = Cs(s);
            if (typeof o == "string" && $_(o, n) === -1 && $_(o, "$<") === -1) {
                var f = r(e, c, u, o);
            ...
            for (var b = [];;) {
                ...
                var L = Cs(C[0]);
                L === "" && (c.lastIndex = FY(u, DY(c.lastIndex), _))
            }
            for (var M = "", B = 0, I = 0; I < b.length; I++) {
                C = b[I];
                for (var K = Cs(C[0]), Y = WY(KY(xY(C.index), u.length), 0), G = [], j = 1; j < C.length; j++) Wf(G, VY(C[j]));
                var z = C.groups;
                if (h) {
                    var ie = HY([K], G, Y, u);
                    z !== void 0 && Wf(ie, z);
                    var oe = Cs(RY(o, void 0, ie))
                } else oe = BY(K, u, Y, G, z, o);
                Y >= B && (M += A_(u, B, Y) + oe, B = Y + K.length)
            }
            return M + A_(u, B)
        }]
    }, !qY || !YY || R_);
    var zY = Lr,
        XY = or,
        JY = function(t, e) {
            return XY(zY[t].prototype[e])
        },
        ZY = JY,
        QY = ZY("String", "replaceAll"),
        eq = QY,
        tq = eq,
        rq = tq,
        nq = rq,
    ...
    const aq = vt({
            ...
            mounted() {
                this.autosize && vK(this.$refs.textarea)
            },
            methods: {
                focus() {
...
`, ""), e.value = s
    ...
    function cq(t, e, r, n, s, o) {
        return se(), le("textarea", {
            ref: "textarea",
            rows: t.rows,
            value: t.modelValue,
            onInput: e[0] || (e[0] = (...c) => t.onInput && t.onInput(...c)),
            onKeypress: e[1] || (e[1] = Rh((...c) => t.onKeypressEnter && t.onKeypressEnter(...c), ["enter"]))
        }, null, 40, oq)
    }
    const lq = Ot(aq, [
            ["render", cq]
        ...
        uq = vt({
            ...
            methods: {
                ...
                async sendAsObject() {
                    ...
                    t[this.player.key || "value"] = this.value;
                    try {
                ...
                async onSubmit() {
                    var t;
                    if (this.send(), !((t = this.player) != null && t.preventResponseLock)) try {
                ...
                onWrite(t) {
                    this.value = t, this.player.live && this.send()
                }
            }
        }),
        fq = {
    ...
    function gq(t, e, r, n, s, o) {
        const c = Tn("TextArea"),
            u = Tn("Input"),
            f = qr("bb");
        return se(), le("div", fq, [ae("div", dq, [t.player.prompt ? tt((se(), le("p", hq, null, 512)), [
            [f, t.player.prompt]
        ]) : We("", !0), t.player.label ? tt((se(), le("label", pq, null, 512)), [
            [f, t.player.label]
        ]) : We("", !0), t.player.isMultiline ? (se(), On(c, {
            key: 2,
            id: "input",
            ...
            "onUpdate:modelValue": t.onWrite
        }, null, 8, ["disabled", "model-value", "placeholder", "rows", "onUpdate:modelValue"])) : (se(), On(u, {
            key: 3,
            id: "input",
            type: "text",
            disabled: t.player.isDisabled,
            ...
            "model-value": t.value,
            "onUpdate:modelValue": t.onWrite
        }, null, 8, ["disabled", "placeholder", "model-value", "onUpdate:modelValue"])), tt(ae("button", {
            onClick: e[0] || (e[0] = cn((...h) => t.onSubmit && t.onSubmit(...h), ["prevent"]))
        }, null, 512), [
            [f, t.player.submitText || "SUBMIT"]
        ])])])
    }
    const mq = Ot(uq, [
            ["render", gq]
        ...
        bq = ["for"],
        Tq = ["id", "value", "rows", "placeholder", "disabled", "onInput"],
        Sq = ["id", "value", "placeholder", "disabled", "onInput"];

    function Oq(t, e, r, n, s, o) {
        const c = qr("bb");
        return se(), le("div", yq, [ae("div", _q, [t.player.prompt ? tt((se(), le("p", Eq, null, 512)), [
            [c, t.player.prompt]
        ]) : We("", !0), (se(!0), le($t, null, io(t.player.inputs, (u, f) => (se(), le($t, null, [u.label ? tt((se(), le("label", {
            key: `label-${u.key}`,
            for: `input-${f}`
        }, null, 8, bq)), [
            [c, u.label]
            ...
            disabled: u.isDisabled,
            onInput: h => t.onValueInput(h, f)
        }, null, 40, Sq))], 64))), 256)), tt(ae("button", {
            onClick: e[0] || (e[0] = cn((...u) => t.onSubmitClick && t.onSubmitClick(...u), ["prevent"]))
        }, null, 512), [
    ...
    function Rq(t, e, r, n, s, o) {
        const c = qr("bb");
        return se(), le("div", Iq, [ae("div", $q, [t.player.message ? tt((se(), le("p", Aq, null, 512)), [
            [c, t.player.message]
        ]) : We("", !0)])])
    }
    const Nq = Ot(Cq, [
    ...
    function Lq(t, e, r, n, s, o) {
        return t.player ? (se(), On(Sh(t.player.kind), {
            key: 0,
            player: t.player,
            class: qe({
            ...
            return t.prototype.tokenizeString = function(e) {
                ...
                return n.forEach(function(f) {
                    var h = r.tags[f.content],
                        m = !0;
                    !h && !o ? f.convertToTextToken() : o ? f.type === ei.Token.Type.endTag && f.content === c ? (o = !1, s.push(t.createTextToken(u))) : (f.convertToTextToken(), u += f.content, m = !1) : h.noNesting && f.type === ei.Token.Type.startTag && (o = !0, c = f.content, u = ""), m && s.push(f)
                }), s
                ...
                return new ei.Token(ei.Token.Type.text, e)
                ...
                if (!e[1]) {
                    ...
                    return new ei.Token(ei.Token.Type.startTag, r, n, e[0])
                }
                return new ei.Token(ei.Token.Type.endTag, e[1].substr(1, e[1].length - 1))
    ...
    var N_ = uO,
        ...
        Mq = function() {
            ...
            return Object.defineProperty(t, "defaultTags", {
                ...
                var o = N_.ParseTree.buildTree(e, this.tags);
    ...
    const Uq = fO.exports,
        ...
        jn = t => (vh("data-v-220ec4c0"), t = t(), yh(), t),
        jq = {
            key: 0,
            ref: "debugNav",
            class: "debug-nav",
        ...
        Wq = jn(() => ae("p", null, "MARKERS", -1)),
        Kq = ["onClick"],
        Hq = di("KILL"),
        Vq = jn(() => ae("br", null, null, -1)),
        Yq = di("ROOM"),
        qq = [Hq, Vq, Yq],
        zq = jn(() => ae("p", {
            class: "title blurred"
    ...
    function o6(t, e, r, n, s, o) {
        return t.replayer ? (se(), le("div", jq, [t.showPowerNav ? (se(), le("div", Gq, [ae("button", {
            class: "close",
            onClick: e[0] || (e[0] = (...c) => t.onClosePowerNavClick && t.onClosePowerNavClick(...c))
        }, "X"), Wq, ae("ul", null, [(se(!0), le($t, null, io(t.replayer.markerMap, (c, u) => (se(), le("li", {
            key: u,
            class: qe({
                active: u === t.replayer.currentMarkerItemIndex
            }),
            onClick: f => t.onMarkerClick(u)
        }, Tt(c[1].marker), 11, Kq))), 128))]), ae("button", {
            class: "option",
            onClick: e[1] || (e[1] = (...c) => t.onKillClick && t.onKillClick(...c))
        }, qq), ae("button", {
            class: "option",
            onClick: e[2] || (e[2] = (...c) => t.onDisconnectClick && t.onDisconnectClick(...c))
        }, "DISCONNECT")])) : We("", !0), zq, t.replayer.markerMap.length ? (se(), le("p", Jq, Tt(t.replayer.currentMarkerItemIndex) + " : " + Tt(t.replayer.currentMarkerItem[1].marker) + " (" + Tt(t.replayer.currentEntityItemIndex) + ") ", 1)) : (se(), le("p", Xq, "Item #" + Tt(t.replayer.currentEntityItemIndex), 1)), t.showPowerNav ? We("", !0) : (se(), le("button", {
            key: 3,
    ...
    var u6 = l6,
        f6 = Qb,
        d6 = f6(Object.keys, Object),
        h6 = d6,
        p6 = Dh,
        g6 = h6,
        m6 = Object.prototype,
        v6 = m6.hasOwnProperty;

    function y6(t) {
        if (!p6(t)) return g6(t);
        var e = [];
        for (var r in Object(t)) v6.call(t, r) && r != "constructor" && e.push(r);
        return e
    }
    var _6 = y6,
        E6 = oT,
    ...
    var dO = k6,
        ...
        D6 = dO,
        M6 = Object.prototype,
        F6 = M6.propertyIsEnumerable,
        L_ = Object.getOwnPropertySymbols,
        U6 = L_ ? function(t) {
            return t == null ? [] : (t = Object(t), x6(L_(t), function(e) {
                return F6.call(t, e)
            }))
        } : D6,
        Ep = U6,
    ...
    var h5 = d5,
        ...
        x5 = ca(jd),
        Gi = mO;
    (Md && Gi(new Md(new ArrayBuffer(1))) != F_ || Fd && Gi(new Fd) != k_ || Ud && Gi(Ud.resolve()) != x_ || Bd && Gi(new Bd) != D_ || jd && Gi(new jd) != M_) && (Gi = function(t) {
        var e = mO(t),
            r = e == R5 ? t.constructor : void 0,
            n = r ? ca(r) : "";
        if (n) switch (n) {
            case N5:
                return F_;
    ...
    function F5(t) {
        ...
        return e && typeof t[0] == "string" && M5.call(t, "index") && (r.index = t.index, r.input = t.input), r
    }
    var U5 = F5,
        B5 = kh;

    function j5(t, e) {
        var r = e ? B5(t.buffer) : t.buffer;
    ...
    function K5(t) {
        var e = new t.constructor(t.source, W5.exec(t));
    ...
    var Lz = Pz,
        ...
        pt = {};
    pt[vO] = pt[lX] = pt[bX] = pt[TX] = pt[uX] = pt[fX] = pt[SX] = pt[OX] = pt[wX] = pt[CX] = pt[IX] = pt[pX] = pt[gX] = pt[_O] = pt[mX] = pt[vX] = pt[yX] = pt[_X] = pt[$X] = pt[AX] = pt[RX] = pt[NX] = !0;
    pt[dX] = pt[yO] = pt[EX] = !1;
    ...
    function Lc(t, e, r, n, s, o) {
        ...
        var m = Qz(t);
        if (m) {
            if (c = Xz(t), !u) return Kz(t, c)
        } else {
            var _ = zz(t),
                b = _ == yO || _ == hX;
            if (eX(t)) return Wz(t, u);
            if (_ == _O || _ == vO || b && !s) {
                if (c = f || b ? {} : Zz(t), !u) return f ? Vz(t, Gz(c, t)) : Hz(t, jz(c, t))
            } else {
                if (!pt[_]) return s ? t : {};
                c = Jz(t, _, u)
            }
        ...
        var C = o.get(t);
        if (C) return C;
        o.set(t, c), nX(t) ? t.forEach(function(B) {
            c.add(Lc(B, e, r, B, t, o))
        }) : tX(t) && t.forEach(function(B, I) {
            c.set(I, Lc(B, e, r, I, t, o))
        });
        var L = h ? f ? qz : Yz : f ? sX : iX,
            M = m ? void 0 : L(t);
        return Uz(M || t, function(B, I) {
            M && (I = B, B = t[I]), Bz(c, I, Lc(B, e, r, I, t, o))
        }), c
    }
    var PX = Lc,
        LX = PX,
    ...
    const MX = vt({
            ...
            mounted() {
                ...
                !t || (this.values = EO(this.$ecastValues), this.content = (n = By.getPromptGuess(this.values, t)) != null ? n : null)
            },
            methods: {
                onFeedbackClick() {
        ...
        KX = zr(() => ae("span", null, [di("LEAVE"), ae("br"), di("FEEDBACK")], -1)),
        HX = [WX, KX],
        VX = zr(() => ae("img", {
            src: TO,
            alt: "Send Debug"
        }, null, -1)),
        YX = zr(() => ae("span", null, [di("SEND A"), ae("br"), di("DEBUG")], -1)),
        qX = [VX, YX],
        zX = {
            key: 1,
            class: "feedback"
    ...
    function h9(t, e, r, n, s, o) {
        return se(), le("div", jX, [t.screen === "options" ? (se(), le("div", GX, [ae("button", {
            class: "feedback-button",
            onClick: e[0] || (e[0] = (...c) => t.onFeedbackClick && t.onFeedbackClick(...c))
        }, HX), ae("button", {
            onClick: e[1] || (e[1] = (...c) => t.onDebugClick && t.onDebugClick(...c))
        }, qX)])) : t.screen === "feedback" ? (se(), le("div", zX, [XX, JX, ae("div", {
            class: qe(["vibes", {
                "has-selected": t.vibe
            }])
        }, [ZX, ae("div", QX, [ae("button", {
            class: qe({
        ...
        }, s9, 2)])], 2), ae("div", a9, [t.content ? (se(), le("div", o9, [tt(ae("input", {
            "onUpdate:modelValue": e[5] || (e[5] = c => t.isContent = c),
            type: "checkbox"
        }, null, 512), [
            [vL, t.isContent]
        ]), ae("span", null, [c9, ae("em", null, Tt(t.content), 1)])])) : We("", !0), tt(ae("textarea", {
        ...
        }, Tt(t.$t("ACTION.SUBMIT")), 1)])])) : t.screen === "debug" ? (se(), le("div", l9, [u9, f9, ae("div", d9, [tt(ae("textarea", {
        ...
        v9 = {
            install: (t, e) => {
                if (!t.config.globalProperties.$debugRecorder && !t.config.globalProperties.$debugReplayer) {
                    if (e.replayer) {
                        t.config.globalProperties.$debugReplayer = e.replayer, t.component("Debug", c6);
                        return
                    }
                    if (t.config.globalProperties.$debugRecorder = new oW(e.client, e.room), !t.config.globalProperties.$showModal) {
                        ...
                        return
                    }(!hr.isProduction || hr.getQueryParam("feedback")) && t.component("Debug", m9), new Uq(() => {
    ...
    function T9(t) {
        for (var e = t.length; e-- && b9.test(t.charAt(e)););
        return e
    }
    var S9 = T9,
        O9 = S9,
    ...
    function C9(t) {
        return t && t.slice(0, O9(t) + 1).replace(w9, "")
    }
    var I9 = C9,
        $9 = ra,
        A9 = gi,
    ...
    function N9(t) {
        return typeof t == "symbol" || A9(t) && $9(t) == R9
    }
    var Ml = N9,
        P9 = I9,
        V_ = un,
    ...
    function F9(t) {
        ...
        t = P9(t);
        var r = x9.test(t);
        return r || D9.test(t) ? M9(t.slice(2), r ? 2 : 8) : k9.test(t) ? Y_ : +t
    }
    var U9 = F9,
        B9 = un,
        Kf = E9,
        q_ = U9,
        j9 = "Expected a function",
        G9 = Math.max,
        W9 = Math.min;
    ...
    function K9(t, e, r) {
        var n, s, o, c, u, f, h = 0,
            ...
            _ = !1,
            b = !0;
        if (typeof t != "function") throw new TypeError(j9);
        e = q_(e) || 0, B9(r) && (m = !!r.leading, _ = "maxWait" in r, o = _ ? G9(q_(r.maxWait) || 0, e) : o, b = "trailing" in r ? !!r.trailing : b);
    ...
    function X9(t, e) {
        if (V9(t)) return !1;
        var r = typeof t;
        return r == "number" || r == "symbol" || r == "boolean" || t == null || Y9(t) ? !0 : z9.test(t) || !q9.test(t) || e != null && t in Object(e)
    }
    var J9 = X9,
        OO = Yb,
        Z9 = "Expected a function";

    function Tp(t, e) {
        if (typeof t != "function" || e != null && typeof e != "function") throw new TypeError(Z9);
        var r = function() {
            var n = arguments,
        ...
        return r.cache = new(Tp.Cache || OO), r
    }
    Tp.Cache = OO;
    var Q9 = Tp,
        e7 = Q9,
    ...
    var n7 = r7,
        ...
        o7 = i7(function(t) {
            var e = [];
            return t.charCodeAt(0) === 46 && e.push(""), t.replace(s7, function(r, n, s, o) {
                e.push(s ? o.replace(a7, "$1") : n || r)
            }), e
        }),
        c7 = o7;
    ...
    function CO(t) {
        ...
        if (f7(t)) return u7(t, CO) + "";
        if (d7(t)) return J_ ? J_.call(t) : "";
        var e = t + "";
        return e == "0" && 1 / t == -h7 ? "-0" : e
    }
    var p7 = CO,
        g7 = p7;
    ...
    function T7(t, e) {
        return y7(t) ? t : _7(t, e) ? [t] : E7(b7(t))
    }
    var IO = T7,
        S7 = Ml,
        O7 = 1 / 0;
    ...
    function w7(t) {
        if (typeof t == "string" || S7(t)) return t;
        var e = t + "";
    ...
    function R7(t, e, r, n) {
        ...
        for (var s = -1, o = e.length, c = o - 1, u = t; u != null && ++s < o;) {
            ...
            if (s != c) {
                var m = u[f];
                h = n ? n(m, f, u) : void 0, h === void 0 && (h = Z_(m) ? m : $7(e[s + 1]) ? [] : {})
            }
            C7(u, f, h), u = u[f]
        }
        return t
    ...
    class x7 {
        ...
        setupWatcher() {
            this.wsClient.entities = Un(this.wsClient.entities), Zi(this.wsClient.entities, (e, r) => {
                this.sync()
            })
        }
        valueForEntity(e) {
    ...
    function Sp() {
        return !M7() && Object.prototype.toString.call(typeof process < "u" ? process : 0) === "[object process]"
    }
    ...
    function Yt() {
        return Sp() ? global : typeof window < "u" ? window : typeof self < "u" ? self : U7
    }
    ...
    function Gd(t, e) {
        try {
            ...
            var o = " > ",
                c = o.length;
            let m;
            for (; u && f++ < r && (m = V7(u, e), !(m === "html" || f > 1 && h + s.length * c + m.length >= n));) s.push(m), h += m.length, u = u.parentNode;
    ...
    function Z7(t) {
        ...
        if (!z7(n)) throw new La(`Invalid Sentry Dsn: Invalid protocol ${n}`);
        if (e && isNaN(parseInt(e, 10))) throw new La(`Invalid Sentry Dsn: Invalid port ${e}`);
        return !0
    }

    function Q7(t) {
        var e = typeof t == "string" ? J7(t) : LO(t);
        return Z7(e), e
    }
    var eJ = Yt(),
        tJ = "Sentry Logger ",
    ...
    let Bt;
    typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__ ? Bt = Op("logger", eE) : Bt = eE();
    ...
    function Cp(t, e) {
        return Xs(t) ? W7(e) ? e.test(t) : typeof e == "string" ? t.indexOf(e) !== -1 : !1 : !1
    }
    ...
    function MO(t) {
        ...
        if (wp(t)) {
            var e = {
                type: t.type,
                target: nE(t.target),
                currentTarget: nE(t.currentTarget),
                ...iE(t)
            };
    ...
    function nE(t) {
        try {
            return G7(t) ? Gd(t) : Object.prototype.toString.call(t)
        } catch {
            return "<unknown>"
        }
    }
    ...
    function rJ(t, e = 40) {
        ...
        if (r[0].length >= e) return tE(r[0], e);
        for (let s = r.length; s > 0; s--) {
            var n = r.slice(0, s).join(", ");
            if (!(n.length > e)) return s === r.length ? n : tE(n, e)
        }
        return ""
    }
    ...
    function sJ() {
        if (!iJ()) return !1;
        var t = Yt();
        if (sE(t.fetch)) return !0;
        let e = !1;
        var r = t.document;
        if (r && typeof r.createElement == "function") try {
            var n = r.createElement("iframe");
            n.hidden = !0, r.head.appendChild(n), n.contentWindow && n.contentWindow.fetch && (e = sE(n.contentWindow.fetch)), r.head.removeChild(n)
        } catch (s) {
...
Error:`, n)
    ...
    function UO(t, e = 3, r = 100 * 1024) {
        var n = bJ(t, e);
        return OJ(n) > r ? UO(t, e - 1, r) : n
    }

    function Hd(t, e, r = 1 / 0, n = 1 / 0, s = EJ()) {
        const [o, c] = s;
        if (e === null || ["number", "boolean", "string"].includes(typeof e) && !H7(e)) return e;
        var u = TJ(t, e);
    ...
    function TJ(t, e) {
        try {
            return t === "domain" && e && typeof e == "object" && e._events ? "[Domain]" : t === "domainEmitter" ? "[DomainEmitter]" : typeof global < "u" && e === global ? "[Global]" : typeof window < "u" && e === window ? "[Window]" : typeof document < "u" && e === document ? "[Document]" : K7(e) ? "[SyntheticEvent]" : typeof e == "number" && e !== e ? "[NaN]" : e === void 0 ? "[undefined]" : typeof e == "function" ? `[Function: ${hi(e)}]` : typeof e == "symbol" ? `[${String(e)}]` : typeof e == "bigint" ? `[BigInt: ${String(e)}]` : `[object ${Object.getPrototypeOf(e).constructor.name}]`
        } catch (r) {
    ...
    class yn {
        ...
        __init3() {
            this._resolve = e => {
                this._setResult(Dn.RESOLVED, e)
            }
        }
        __init4() {
            this._reject = e => {
                this._setResult(Dn.REJECTED, e)
            }
        }
        __init5() {
            this._setResult = (e, r) => {
    ...
    var wJ = ["fatal", "error", "warning", "log", "info", "debug"];

    function CJ(t) {
        return t === "warn" ? "warning" : wJ.includes(t) ? t : "log"
    }
    var Vd = {
    ...
    class rs {
        ...
        addBreadcrumb(e, r) {
            var n = typeof r == "number" ? Math.min(r, lE) : lE;
            if (n <= 0) return this;
            var s = {
                timestamp: BO(),
                ...e
    ...
    class go {
        ...
        endSession() {
            var e = this.getStackTop(),
                r = e && e.scope,
                n = r && r.getSession();
            n && RJ(n), this._sendSessionUpdate(), r && r.setSession()
        }
        startSession(e) {
            const {
                scope: r,
    ...
    function Pr() {
        var t = Bl();
        return (!KO(t) || si(t).isOlderThan($p)) && Ap(t, new go), Sp() ? LJ(t) : si(t)
    }
    ...
    function LJ(t) {
        try {
            ...
            if (!r) return si(t);
            if (!KO(r) || si(r).isOlderThan($p)) {
                var n = si(t).getStackTop();
                Ap(r, new go(n.client, rs.clone(n.scope)))
            }
            return si(r)
        } catch {
            return si(t)
    ...
    class eo {
        ...
        setupOnce() {
            fE = Function.prototype.toString, Function.prototype.toString = function(...e) {
                var r = Ip(this) || this;
                return fE.apply(r, e)
            }
        }
    ...
    eo.__initStatic();
    var FJ = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/];
    class js {
        static __initStatic() {
    ...
    function UJ(t = {}, e = {}) {
        return {
            ...
            ignoreErrors: [...t.ignoreErrors || [], ...e.ignoreErrors || [], ...FJ],
            ignoreInternal: t.ignoreInternal !== void 0 ? t.ignoreInternal : !0
        }
    }

    function BJ(t, e) {
        return e.ignoreInternal && HJ(t) ? ((typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) && Bt.warn(`Event dropped due to being internal Sentry Error.
Event: ${Rs(t)}`), !0) : jJ(t, e.ignoreErrors) ? ((typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) && Bt.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${Rs(t)}`), !0) : GJ(t, e.denyUrls) ? ((typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) && Bt.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${Rs(t)}.
Url: ${Qc(t)}`), !0) : WJ(t, e.allowUrls) ? !1 : ((typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) && Bt.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${Rs(t)}.
Url: ${Qc(t)}`), !0)
    }

    function jJ(t, e) {
        return !e || !e.length ? !1 : KJ(t).some(r => e.some(n => Cp(r, n)))
    }

    function GJ(t, e) {
        if (!e || !e.length) return !1;
        var r = Qc(t);
        return r ? e.some(n => Cp(r, n)) : !1
    }

    function WJ(t, e) {
        if (!e || !e.length) return !0;
        var r = Qc(t);
        return r ? e.some(n => Cp(r, n)) : !0
    }
    ...
    function YJ(t, e, r, n) {
        var s = {
            exception: {
                values: [{
                    type: wp(e) ? e.constructor.name : n ? "UnhandledRejection" : "Error",
                    value: `Non-Error ${n?"promise rejection":"exception"} captured with keys: ${rJ(e)}`
                }]
            },
            extra: {
                __serialized__: UO(e)
    ...
    function VO(t, e, r, n, s) {
        ...
        if (Fl(e) || wp(e)) {
            var m = e;
            return o = YJ(t, m, r, s), Zc(o, {
                synthetic: !0
            }), o
        }
        return o = dE(t, e, r, n), Kd(o, `${e}`, void 0), Zc(o, {
            synthetic: !0
        }), o
    }
    ...
    class to {
        ...
        setupOnce() {
            this.options.console && qi("console", QJ), this.options.dom && qi("dom", ZJ(this.options.dom)), this.options.xhr && qi("xhr", eZ), this.options.fetch && qi("fetch", tZ), this.options.history && qi("history", rZ)
        }
    }
    to.__initStatic();
    ...
    function QJ(t) {
        ...
        if (t.level === "assert")
            if (t.args[0] === !1) e.message = `Assertion failed: ${rE(t.args.slice(1)," ")||"console.assert"}`, e.data.arguments = t.args.slice(1);
            else return;
        Pr().addBreadcrumb(e, {
            input: t.args,
            level: t.level
    ...
    class li {
        ...
        __init2() {
            this._installFunc = {
                onerror: iZ,
                onunhandledrejection: sZ
            }
        }
        constructor(e) {
            li.prototype.__init.call(this), li.prototype.__init2.call(this), this._options = {
                onerror: !0,
        ...
        setupOnce() {
            ...
            for (var r in e) {
                ...
                n && e[r] && (cZ(r), n(), this._installFunc[r] = void 0)
            }
        }
    }
    li.__initStatic();
    ...
    function iZ() {
        qi("error", t => {
            ...
            if (!(YO() || f && f.__sentry_own_request__)) {
                var h = f === void 0 && Xs(s) ? oZ(s, o, c, u) : qO(VO(r, f || s, void 0, n, !1), o, c, u);
    ...
    function sZ() {
        qi("unhandledrejection", t => {
            ...
            var o = j7(s) ? aZ(s) : VO(r, s, void 0, n, !0);
    ...
    class ro {
        ...
        setupOnce() {
            var e = Yt();
            this._options.setTimeout && sr(e, "setTimeout", hE), this._options.setInterval && sr(e, "setInterval", hE), this._options.requestAnimationFrame && sr(e, "requestAnimationFrame", uZ), this._options.XMLHttpRequest && "XMLHttpRequest" in e && sr(XMLHttpRequest.prototype, "send", fZ);
    ...
    class Gs {
        ...
        constructor(e = {}) {
            Gs.prototype.__init.call(this), this._key = e.key || hZ, this._limit = e.limit || pZ
        }
        setupOnce() {
            var e = Pr().getClient();
            !e || WO((r, n) => {
                var s = Pr().getIntegration(Gs);
                return s ? gZ(e.getOptions().stackParser, s._key, s._limit, r, n) : r
            })
        }
    }
    Gs.__initStatic();

    function gZ(t, e, r, n, s) {
    ...
    class Ks {
        ...
        setupOnce(e, r) {
            var n = s => {
                ...
                if (o) {
                    try {
                        if (mZ(s, o._previousEvent)) return (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) && Bt.warn("Event dropped due to being a duplicate of previously captured event."), null
                    } catch {
    ...
    new js, new eo, new ro, new to, new li, new Gs, new Ks, new Ws;
    ...
    function _Z(t = {}, e = Pr()) {
        ...
        c.async = !0, c.src = MJ(o, t), t.onLoad && (c.onload = t.onLoad);
...
${e}`
        ...
        wZ = mo(() => ae("h1", null, "You have encountered an error", -1)),
        CZ = mo(() => ae("p", null, "Something went wrong! But don't worry, you can try a few things to get going.", -1)),
        IZ = mo(() => ae("ul", null, [ae("li", null, "Refresh the page"), ae("li", null, "Turn off adblockers or other browser extensions."), ae("li", null, "Check your connection to the Internet."), ae("li", null, "Make sure you're using an up-to-date browser."), ae("li", null, "If that doesn't work, let us know.")], -1)),
        $Z = mo(() => ae("hr", null, null, -1)),
        AZ = {
            class: "error"
        };

    function RZ(t, e, r, n, s, o) {
        return se(), le("div", bZ, [ae("div", TZ, [SZ, ae("div", OZ, [wZ, CZ, IZ, ae("button", {
            onClick: e[0] || (e[0] = (...c) => t.onFeedbackClick && t.onFeedbackClick(...c))
        }, "Tell us what happened"), $Z, ae("pre", AZ, Tt(t.message), 1)])])])
    }
    const NZ = Ot(EZ, [
            ["render", RZ],
        ...
        PZ = {
            install: t => {
                ...
                }, t.component("Fatal", NZ), t.config.globalProperties.$handleEcastError = e
            }
        };
    var LZ = IO,
        kZ = $O;
    ...
    function xZ(t, e) {
        e = LZ(e, t);
        for (var r = 0, n = e.length; t != null && r < n;) t = t[kZ(e[r++])];
    ...
    function HZ(t) {
        var e = t.length;
        return e ? t[KZ(0, e - 1)] : void 0
    }
    var ew = HZ,
        VZ = wO;

    function YZ(t, e) {
        return VZ(e, function(r) {
            return t[r]
        })
    }
    var qZ = YZ,
    ...
    function mE(t, e) {
        const r = t.global.locale,
            ...
            s = UZ(n, e);
        return Array.isArray(s) || console.warn(`[i18nPlugin] Translation with key ${e} is not an array`), oQ(s)
    }
    const cQ = {
            install: (t, e) => {
                t.directive("ts", (r, n) => {
                    const s = mE(e.i18n, n.value);
                    r.textContent = s || ""
    ...
    function _Q(t, e, r, n, s, o) {
        const c = qr("bb");
        return se(), le("div", {
            class: qe(["error-model", t.classes])
        }, [t.image === "tear" ? (se(), le("img", hQ)) : t.image === "moon" ? (se(), le("img", pQ)) : (se(), le("img", gQ)), tt(ae("h3", mQ, null, 512), [
            [c, t.text]
        ]), t.subtext ? tt((se(), le("h3", vQ, null, 512)), [
            [c, t.subtext]
        ]) : We("", !0), ae("div", yQ, [tt(ae("button", {
    ...
    function CQ(t, e, r, n, s, o) {
        ...
        }, [tt(ae("h3", TQ, null, 512), [
            [c, t.text]
        ]), t.subtext ? tt((se(), le("h3", SQ, null, 512)), [
            [c, t.subtext]
        ]) : We("", !0), ae("div", OQ, [(se(!0), le($t, null, io(t.options, (u, f) => tt((se(), le("button", {
            key: f,
            class: qe(u.classes),
    ...
    const IQ = Ot(bQ, [
        ...
        $Q = vt({
            ...
            methods: {
                show(t, e = {}, r = {}) {
                    return this.props = e, this.classes = r.classes || "jbg", t === "Error" ? this.content = EQ : t === "Options" ? this.content = IQ : this.content = t, new Promise(n => {
                        this.resolve = n
                    })
                },
                onResolve(...t) {
    ...
    function AQ(t, e, r, n, s, o) {
        return se(), On(gl, {
            ...
            default: _h(() => [t.props ? (se(), le("div", {
                ...
                onKeyup: e[0] || (e[0] = Rh((...c) => t.onBackgroundClick && t.onBackgroundClick(...c), ["esc"])),
                onClick: e[1] || (e[1] = cn((...c) => t.onBackgroundClick && t.onBackgroundClick(...c), ["self"]))
            }, [t.content ? (se(), On(Sh(t.content), $h({
                key: 0,
                class: "content"
            }, t.props, {
    ...
    const RQ = Ot($Q, [
        ...
        NQ = {
            install: t => {
                ...
                t.component("Modal", RQ), t.config.globalProperties.$showModal = r, t.config.globalProperties.$registerModal = n
            }
        },
        PQ = vt({
            setup() {
    ...
    function kQ(t, e, r, n, s, o) {
        return se(), le("div", LQ, [(se(!0), le($t, null, io(t.lines, c => (se(), le("p", {
            key: c.id
        }, Tt(c.text), 1))), 128))])
    }
    const xQ = Ot(PQ, [
        ...
        DQ = {
            install: t => {
                ...
                t.provide(po.textDescriptions.announcement, Rr(() => vE.value));
                const e = r => {
                    vE.value = r
                };
                t.component("TextDescriptions", xQ), t.config.globalProperties.$announce = e
            }
        },
        MQ = {
            install: t => {
    ...
    const qd = typeof window < "u",
        UQ = typeof Symbol == "function" && typeof Symbol.toStringTag == "symbol",
        Ti = t => UQ ? Symbol(t) : t,
        BQ = (t, e, r) => jQ({
            l: t,
            k: e,
        ...
        jQ = t => JSON.stringify(t).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"),
        Ut = t => typeof t == "number" && isFinite(t),
        GQ = t => Pp(t) === "[object Date]",
        pi = t => Pp(t) === "[object RegExp]",
    ...
    const gt = Array.isArray,
        ...
        Pp = t => tw.call(t),
        Me = t => Pp(t) === "[object Object]",
        HQ = t => t == null ? "" : gt(t) || Me(t) && t.toString === tw ? JSON.stringify(t, null, 2) : String(t);
    /*!
    ...
    const kn = " ",
        ...
        dr = `
`,
        zQ = String.fromCharCode(8232),
        XQ = String.fromCharCode(8233);
    ...
    function QQ(t, e = {}) {
        ...
        function M(g) {
            let p = "";
            for (; g.currentPeek() === kn || g.currentPeek() === dr;) p += g.currentPeek(), g.peek();
            return p
        }
        ...
        function ue(g, p) {
            ...
            const D = () => {
                    ...
                    return V === "{" ? I(g.peek()) : V === "@" || V === "%" || V === "|" || V === ":" || V === "." || V === kn || !V ? !1 : V === dr ? (g.peek(), D()) : I(V)
                },
                U = D();
            return g.resetPeek(), U
        }
        ...
        function fe(g, p = !0) {
            const O = (U = !1, V = "", ce = !1) => {
                    ...
                    return re === "{" ? V === "%" ? !1 : U : re === "@" || !re ? V === "%" ? !0 : U : re === "%" ? (g.peek(), O(U, "%", !0)) : re === "|" ? V === "%" || ce ? !0 : !(V === kn || V === dr) : re === kn ? (g.peek(), O(!0, kn, ce)) : re === dr ? (g.peek(), O(!0, dr, ce)) : !0
                },
                D = O();
        ...
        function we(g, p) {
            ...
            return O === ti ? ti : p(O) ? (g.next(), O) : null
        }
        ...
        function xe(g) {
            ...
            let p = "",
                O = "";
            for (; p = F(g);) O += p;
            return g.currentChar() === ti && _(Qe.UNTERMINATED_CLOSING_BRACE, o(), 0), O
        }

        function Ue(g) {
            B(g);
            let p = "";
            return g.currentChar() === "-" ? (g.next(), p += `-${Ee(g)}`) : p += Ee(g), g.currentChar() === ti && _(Qe.UNTERMINATED_CLOSING_BRACE, o(), 0), p
        }
        ...
        function Ze(g) {
            ...
            let p = "",
                O = "";
            const D = V => V !== _E && V !== dr;
            for (; p = we(g, D);) p === "\\" ? O += Ct(g) : O += p;
            const U = g.currentChar();
            return U === dr || U === ti ? (_(Qe.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, o(), 0), U === dr && (g.next(), L(g, "'")), O) : (L(g, "'"), O)
        }
        ...
        function nt(g) {
            const p = (O = !1, D) => {
                const U = g.currentChar();
                return U === "{" || U === "%" || U === "@" || U === "|" || !U || U === kn ? D : U === dr ? (D += U, g.next(), p(O, D)) : (D += U, g.next(), p(!0, D))
            };
            return p(!1, "")
        }
        ...
        function Lt(g, p) {
            ...
            let D = null;
            const U = g.currentChar();
            switch ((O === 8 || O === 9 || O === 12 || O === 10) && (U === dr || U === kn) && _(Qe.INVALID_LINKED_FORMAT, o(), 0), U) {
                case "@":
        ...
        function kt() {
            ...
            return f.lastType = g, f.lastOffset = p, f.lastStartLoc = O, f.lastEndLoc = D, f.offset = s(), f.startLoc = o(), n.currentChar() === ti ? b(f, 14) : Wt(n, f)
        }
        return {
            nextToken: kt,
            currentOffset: s,
    ...
    const eee = "parser",
        tee = /(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g;
    ...
    function nee(t = {}) {
        ...
        function h(I, K) {
            const Y = I.context(),
                ...
                z = s(9, G, j);
            return z.value = K.replace(tee, ree), I.nextToken(), o(z, I.currentOffset(), I.currentPosition()), z
        }
    ...
    function EE(t, e) {
        for (let r = 0; r < t.length; r++) Lp(t[r], e)
    }

    function Lp(t, e) {
        switch (t.type) {
            case 1:
                EE(t.cases, e), e.helper("plural");
                break;
            case 2:
                EE(t.items, e);
                break;
            case 6:
                Lp(t.key, e), e.helper("linked"), e.helper("type");
                break;
            case 5:
    ...
    function see(t, e = {}) {
        const r = iee(t);
        r.helper("normalize"), t.body && Lp(t.body, r);
        const n = r.context();
...
`,
    ...
    function yee(t) {
        const e = t.trim();
        return t.charAt(0) === "0" && isNaN(parseInt(t)) ? !1 : gee(e) ? mee(e) : "*" + e
    }
    ...
    function _ee(t) {
        ...
        b[0] = () => {
            ...
            if (s > 0) s--, n = 4, b[0]();
                ...
                if (s = 0, c === void 0 || (c = yee(c), c === !1)) return !1;
                b[1]()
            }
        };
        ...
        for (; n !== null;)
            if (r++, o = t[r], !(o === "\\" && C())) {
                if (f = vee(o), _ = Si[n], h = _[f] || _.l || 8, h === 8 || (n = h[0], h[1] !== void 0 && (m = b[h[1]], m && (u = o, m() === !1)))) return;
                if (n === 7) return e
            }
    }
    const bE = new Map;
    ...
    function bee(t, e) {
        if (!mt(t)) return null;
        let r = bE.get(e);
        if (r || (r = _ee(e), r && bE.set(e, r)), !r) return null;
        const n = r.length;
        let s = t,
            o = 0;
        for (; o < n;) {
    ...
    function Aee(t = {}) {
        const e = t.locale,
            r = Iee(t),
            n = mt(t.pluralRules) && ye(e) && Nt(t.pluralRules[e]) ? t.pluralRules[e] : TE,
            s = mt(t.pluralRules) && ye(e) && Nt(t.pluralRules[e]) ? TE : void 0,
            o = I => I[n(r, I.length, s)],
            c = t.list || [],
            u = I => c[I],
            f = t.named || {};
        Ut(t.pluralIndex) && $ee(r, f);
        const h = I => f[I];

        function m(I) {
            const K = Nt(t.messages) ? t.messages(I) : mt(t.messages) ? t.messages[I] : !1;
            return K || (t.parent ? t.parent.message(I) : See)
        }
        const _ = I => t.modifiers ? t.modifiers[I] : Tee,
            b = Me(t.processor) && Nt(t.processor.normalize) ? t.processor.normalize : wee,
            C = Me(t.processor) && Nt(t.processor.interpolate) ? t.processor.interpolate : Cee,
            L = Me(t.processor) && ye(t.processor.type) ? t.processor.type : Oee,
            B = {
                list: u,
                named: h,
                plural: o,
    ...
    function rw(t, e, r) {
        ...
        if (!o) {
            ...
            c = ye(u) ? [u] : u, gt(c) && SE(o, c, !1), s.__localeChainCache.set(n, o)
        }
        return o
    }
    ...
    const Dee = "9.2.2",
        ...
        vo = "en-US",
        OE = "",
        wE = t => `${t.charAt(0).toLocaleUpperCase()}${t.substr(1)}`;
    ...
    function Mee() {
        return {
            ...
            capitalize: (t, e) => e === "text" && ye(t) ? wE(t) : e === "vnode" && mt(t) && "__v_isVNode" in t ? wE(t.children) : t
        }
    }
    let nw;
    ...
    function jee(t = {}) {
        const e = ye(t.version) ? t.version : Dee,
            ...
            Y = Nt(t.messageResolver) ? t.messageResolver : iw || Eee,
            G = Nt(t.localeFallbacker) ? t.localeFallbacker : sw || Lee,
            j = mt(t.fallbackContext) ? t.fallbackContext : void 0,
            z = Nt(t.onWarn) ? t.onWarn : WQ,
            ie = t,
    ...
    function Wee(t, e = {}) {
        {
            const n = (e.onCacheKey || Gee)(t),
                s = IE[n];
            if (s) return s;
            let o = !1;
            const c = e.onError || VQ;
            e.onError = h => {
                o = !0, c(h)
            };
            const {
                code: u
            } = dee(t, e), f = new Function(`return ${u}`)();
            return o ? f : IE[n] = f
        }
    }
    ...
    function Kee(t) {
        gt(t.list) ? t.list = t.list.map(e => ye(e) ? yE(e) : e) : mt(t.named) && Object.keys(t.named).forEach(e => {
            ye(t.named[e]) && (t.named[e] = yE(t.named[e]))
        })
    }
    ...
    function Vee(t, e, r, n, s, o) {
        return {
            warnHtmlMessage: s,
            onError: c => {
                throw o && o(c), c
            },
            onCacheKey: c => BQ(e, r, c)
        }
    }
    ...
    function RE(t, ...e) {
        ...
        for (let z = 0; z < M.length && (I = M[z], B = r[I] || {}, K = B[f], !Me(K)); z++) kp(t, f, I, b, Y);
    ...
    function Kl(t, e) {
        ...
        if (gt(n) && n.forEach(u => {
            ...
            for (const u in c) Np(c, u) && rh(c[u]);
        return c
    }
    ...
    function Ga(t, e) {
        ...
        for (const r in t) Np(t, r) && (Oc(t[r]) || Oc(e[r]) ? e[r] = t[r] : Ga(t[r], e[r]))
    }
    ...
    function xp(t = {}, e) {
        ...
        let m = r ? r.missingWarn : ze(t.missingWarn) || pi(t.missingWarn) ? t.missingWarn : !0,
            ...
            M = Nt(t.missing) ? DE(t.missing) : null,
        ...
        j = (() => {
            ...
            return A.datetimeFormats = f.value, A.numberFormats = h.value, A.__datetimeFormatters = Me(j) ? j.__datetimeFormatters : void 0, A.__numberFormatters = Me(j) ? j.__numberFormatters : void 0, jee(A)
        ...
        function ve(...A) {
            return Ee(W => Reflect.apply(AE, null, [W, ...A]), () => Xd(...A), "translate", W => Reflect.apply(W.t, W, [...A]), W => W, W => ye(W))
        }
        ...
        function xe(...A) {
            return Ee(W => Reflect.apply(RE, null, [W, ...A]), () => Jd(...A), "datetime format", W => Reflect.apply(W.d, W, [...A]), () => OE, W => ye(W))
        }

        function Ue(...A) {
            return Ee(W => Reflect.apply(PE, null, [W, ...A]), () => Zd(...A), "number format", W => Reflect.apply(W.n, W, [...A]), () => OE, W => ye(W))
        }

        function Ze(A) {
            return A.map(W => ye(W) || Ut(W) || ze(W) ? kE(String(W)) : W)
        }
        const Sr = {
            normalize: Ze,
            interpolate: A => A,
        ...
        function er(...A) {
            return Ee(W => {
                ...
                const pe = W;
                try {
                    pe.processor = Sr, he = Reflect.apply(AE, null, [pe, ...A])
                } finally {
                    pe.processor = null
                }
                return he
            }, () => Xd(...A), "translate", W => W[Qd](...A), W => [kE(W)], W => gt(W))
        }

        function pr(...A) {
            return Ee(W => Reflect.apply(PE, null, [W, ...A]), () => Zd(...A), "number format", W => W[th](...A), () => [], W => ye(W) || gt(W))
        }

        function nt(...A) {
            return Ee(W => Reflect.apply(RE, null, [W, ...A]), () => Jd(...A), "datetime format", W => W[eh](...A), () => [], W => ye(W) || gt(W))
        }
        ...
        function D(A, W) {
            f.value[A] = W, j.datetimeFormats = f.value, NE(j, A, W)
        }

        function U(A, W) {
            f.value[A] = Zt(f.value[A] || {}, W), j.datetimeFormats = f.value, NE(j, A, W)
        }
        ...
        function ce(A, W) {
            h.value[A] = W, j.numberFormats = h.value, LE(j, A, W)
        }

        function re(A, W) {
            h.value[A] = Zt(h.value[A] || {}, W), j.numberFormats = h.value, LE(j, A, W)
        }
        xE++, r && qd && (Zi(r.locale, A => {
    ...
    function mw(t, e, r, n) {
        ...
        return () => {
            ...
            gt(f) ? h = f.map((b, C) => {
                ...
                return Zee(M) && (M[0].key = `${b.type}-${C}`), M
            }) : ye(f) && (h = [f]);
            const m = Zt({}, o),
    ...
    function ete(t) {
        const e = c => {
            ...
            const m = Qee(t, u.$),
                _ = BE(h);
            return [Reflect.apply(m.t, m, [...jE(_)]), m]
        };
        return {
            created: (c, u) => {
                const [f, h] = e(u);
            ...
            beforeUpdate: (c, {
                ...
                if (c.__composer) {
                    const f = c.__composer,
                        h = BE(u);
                    c.textContent = Reflect.apply(f.t, f, [...jE(h)])
                }
            },
            getSSRProps: c => {
                const [u] = e(c);
    ...
    function tte(t, e, ...r) {
        ...
        (ze(n.globalInstall) ? n.globalInstall : !0) && (t.component(s ? "i18n" : ME.name, ME), t.component(FE.name, FE), t.component(UE.name, UE)), t.directive("t", ete(e))
    }
    ...
    function rte(t, e, r) {
        return {
            beforeCreate() {
                ...
                if (s.i18n) {
                    const o = s.i18n;
                    s.__i18n && (o.__i18n = s.__i18n), o.__root = e, this === this.$root ? this.$i18n = GE(t, o) : (o.__injectWithOption = !0, this.$i18n = nh(o))
                } else s.__i18n ? this === this.$root ? this.$i18n = GE(t, s) : this.$i18n = nh({
                    __i18n: s.__i18n,
    ...
    function ite(t = {}, e) {
        ...
        function _(b) {
            ...
            const b = {
                ...
                async install(C, ...L) {
                    C.__VUE_I18N_SYMBOL__ = f, C.provide(C.__VUE_I18N_SYMBOL__, b), !r && n && pte(C, b.global), tte(C, b, ...L), r && C.mixin(rte(u, u.__composer, b));
                    const M = C.unmount;
                    C.unmount = () => {
                        b.dispose(), M()
                    }
    ...
    function Mp(t = {}) {
        ...
        if (o === "parent") {
            let f = lte(r, e, t.__useComponent);
            return f == null && (f = n), f
        }
        const c = r;
        ...
        if (u == null) {
            const f = Zt({}, t);
            "__i18n" in s && (f.__i18n = s.__i18n), n && (f.__root = n), u = xp(f), ute(c, e), c.__setInstance(e, u)
        }
        return u
    }
    ...
    function ste(t, e, r) {
        const n = uN(); {
            const s = e ? n.run(() => nh(t)) : n.run(() => xp(t));
    ...
    function ate(t) {
        {
            const e = Ji(t.isCE ? nte : t.appContext.app.__VUE_I18N_SYMBOL__);
    ...
    const dte = ["locale", "fallbackLocale", "availableLocales"],
        hte = ["t", "rt", "d", "n", "tm"];
    ...
    function pte(t, e) {
        ...
        }), t.config.globalProperties.$i18n = r, hte.forEach(n => {
            const s = Object.getOwnPropertyDescriptor(e, n);
    ...
    function Tte(t, e, r, n, s, o) {
        return se(), On(gl, {
            ...
            default: _h(() => [t.isVisible && t.options ? (se(), le("div", {
                ...
                onKeydown: e[1] || (e[1] = Rh((...c) => t.hide && t.hide(...c), ["esc"]))
            }, null, 32), ae("p", yte, Tt(t.options.text), 1), ae("p", _te, Tt(t.options.subtext), 1), t.options.warning ? (se(), le("p", Ete, Tt(t.options.warning), 1)) : We("", !0), t.options.type === "reconnecting" ? (se(), le("div", bte)) : We("", !0)])], 2)) : We("", !0)]),
            _: 1
        })
    }
    const Ste = Ot(gte, [
        ...
        Ote = {
            install: t => {
                ...
                t.component("Toast", Ste), t.config.globalProperties.$showToast = r, t.config.globalProperties.$hideToast = n, t.config.globalProperties.$registerToast = s
            }
        },
        wte = vt({
            props: {
    ...
    function Cte(t, e, r, n, s, o) {
        const c = Tn("Fatal"),
            u = Tn("TextDescriptions"),
            f = Tn("Debug"),
            h = Tn("Modal"),
            m = Tn("Toast");
        return t.shouldShowFatal ? (se(), On(c, {
            key: 0
        })) : (se(), le($t, {
            key: 1
        }, [xt(u), (se(), On(Sh(t.mainView), $h({
            id: "game",
            class: t.classes
            ...
            window.tv.register({
                ...
                mount: r => {
                    ...
                    if (n.use(Fq), n.use(NQ), n.use(v9, {
                            ...
                            i18n: o
                        }), n.use(DQ), n.use(MQ), n.use(Ote), n.use(FQ), t.plugins) {
    ...
    function Rte(t, e, r, n, s, o) {
        const c = Tn("Fallbacks");
        return se(), le("div", Ate, [t.player ? (se(), On(c, {
            key: 0,
            player: t.player
        }, null, 8, ["player"])) : We("", !0)])
    }
...
export default Pte();
//# sourceMappingURL=33a08e54.js.map