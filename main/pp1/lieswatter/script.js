				...
				<div id="lieswatter-stats" style="background:#515151; padding-bottom: 5px;">
					...
					<tr>
						<td style="padding:10px; width=80px;">
							<div style="text-align:center; font-family:'Ubuntu', sans-serif; color:white;"><span>POSICIÓN</span><br /></div>
						...
						<td style="padding:10px; width=80px;">
							<div style="text-align:center; font-family:'Ubuntu', sans-serif; color:white;"><span>RACHA</span><br /></div>
...
const zx = VC.extend({
    ...
    async update() {
        const t = this.model.get("player"),
            ...
            n = t ? t.state : "",
            i = e ? e.state : "";
        if (n === "RoomFull") Ot.show(Error("La sala está llena"), {
            willClose: () => {
                window.location.reload(!0)
            }
        });
            ...
            const a = i.split("_")[1];
            a === "CanStart" ? (ye("#lieswatter-lobby-text").html("Pulsa este botón cuando todos se hayan unido"), ye("#lieswatter-startgame").show()) : a === "PostGame" && (ye("#lieswatter-lobby-text").html("¿Qué quieres hacer?"), ye(".lieswatter-endbuttons").show()), this.showScreen(".state-lobby")
