		...
		<div class="pt-page-off state-lobby drawful-page">\r
			<div class="container">\r
				...
				<form class="pure-form">					\r
					<button type="button" id="drawful-startgame" class="button-drawful button-xlarge pure-button pure-input-1">estamos todos</button>\r
					<button type="button" id="drawful-stopcountdown" class="button-drawful button-xlarge pure-button pure-input-1">cancelar</button>\r
					<button type="button" id="drawful-sameplayers" class="button-drawful button-xlarge pure-button pure-input-1 drawful-endbuttons">mismos jugadores</button>\r
					<button type="button" id="drawful-newplayers" class="button-drawful button-xlarge pure-button pure-input-1 drawful-endbuttons">nuevos jugadores</button>	\r
				</form>\r
			</div>\r
		</div>\r
\r
...
\r
		<div class="pt-page-off state-drawing-sent drawful-page">\r
			<div class="container">\r
				...
				<span class='drawful-text'>gracias por tu dibujo</span><br />\r
			</div>\r
		</div>\r
\r
		<div class="pt-page-off state-drawing-done drawful-page">\r
			<div class="container">\r
				<br /><span class='drawful-text'>¡el tiempo para dibujar se acabó!</span><br />\r
			</div>\r
		</div>		\r
\r
...
\r
				...
				<form class="pure-form" id="drawful-enterlie-field">\r
					<div class="pure-u-1">\r
						<input id="drawful-lie-input" name="drawful-lie" class="pure-input-1 jbg-input" type="text" maxlength="45" placeholder="ingresa un título" autocapitalize="off" autocorrect="off" autocomplete="off">\r
					</div>\r
					<div class="pure-u-1 right">\r
						<button type="submit" id="drawful-submitlie" class="button-drawful button-xlarge pure-button right"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;enviar</button>\r
...
\r
		<div class="pt-page-off state-liereceived drawful-page">\r
			<div class="container">\r
				<br /><span class='drawful-text'>¡título ingresado!<br />esperando a los demás jugadores.</span><br />\r
			</div>\r
		</div>\r
\r
		<div class="pt-page-off state-lyingdone drawful-page">\r
			<div class="container">\r
				<br /><span class='drawful-text'>¡hecho!</span><br />\r
			</div>\r
		</div>		\r
\r
...
\r
		<div class="pt-page-off state-draw drawful-page">\r
			<!-- <div class="container"> -->\r
				<span id="drawful-prompt" class='prompt drawful-text'>por favor dibuja:</span><br />\r
				<span id="drawful-instructions" class='instructions drawful-text'>¡un autorretrato!</span><br />\r
\r
				...
				<form class="pure-form container">\r
					<button type="submit" id="drawful-submitdrawing" class="submit-drawing button-drawful button-large pure-button pure-input-1" style="margin-top: 0px;"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;enviar</button>\r
...
const Hx = lc.extend({
    ...
    lacksAudience: !0,
    authorMessages: ["tú dibujaste esto. piensa en lo que has hecho.", "tú dibujaste esto. relájate.", "tú dibujaste esto. espera a que todos se den cuenta de lo que hiciste.", "tú dibujaste esto. no hay vuelta atrás", "tú dibujaste esto. toma un respiro.", "tú dibujaste esto. eres todopoderoso.", "tú dibujaste esto. ¿cómo te sientes al respecto?", "tú dibujaste esto. esto es tu culpa.", "tú dibujaste esto. es... ¿bueno?", "tú dibujaste esto. ¡viva!", "tú dibujaste esto. veamos qué sucede."],
    events: {
    ...
    async update() {
        ...
        if (t && t.hasPicture === !1) {
            ...
            this.enableLoadingButton("#drawful-submitdrawing", !0), this.showScreen(".state-draw"), fe(".drawful .state-draw .instructions").html("¡un autorretrato!");
        ...
        if (this.joiningInterfaceIsUp = !1, i && i === "Lobby" && n === i) {
            ...
            f === "WaitingForMore" ? fe("#drawful-lobby-text").html("esperando a que todos los jugadores se unan") : f === "CanStart" ? (fe("#drawful-lobby-text").html("pulsa este botón cuando todos se hayan unido"), fe("#drawful-startgame").show()) : f === "Countdown" ? (fe("#drawful-lobby-text").html("pulsa este botón para cancelar el inicio de la partida"), fe("#drawful-stopcountdown").show()) : f === "PostGame" && (fe("#drawful-lobby-text").html("¿qué quieres hacer?"), fe(".drawful-endbuttons").show()), this.showScreen(".state-lobby")
        } else if (i === "Gameplay_Logo") this.showScreen(".state-nothing");
        else if (i === "Gameplay_Round") fe(".round-text").html(`RONDA ${e.round}`), this.showScreen(".state-round");
            ...
            if (this.activeScreen !== ".state-enterlie" && (t.isAuthor ? (fe("#drawful-lie-input").hide(), fe("#drawful-enterlie-field").hide(), fe("#drawful-submit-alert").hide(), fe("#drawful-submitlie").hide(), fe(".state-enterlie .author-text").html(this.authorMessages[Math.floor(Math.random() * this.authorMessages.length)])) : (fe(".state-enterlie .author-text").html(""), fe("#drawful-lie-input").val(""), fe("#drawful-lie-input").show(), fe("#drawful-enterlie-field").show(), fe("#drawful-submitlie").show(), fe("#drawful-submit-alert").hide())), t.showError) {
                ...
                fe("#drawful-submit-alert").html("¡ingresaste el título correcto! ¡ingresa uno falso!"), f.addClass("alert-info"), f.removeClass("alert-danger"), f.show()
            }
            ...
            if (t.choosingDone || t.chosen != null || t.isAuthor) {
                t.isAuthor ? fe("#chooselikes-choice").html("") : fe("#chooselikes-choice").html(t.chosen ? `elegiste: ${t.chosen}` : "no elegiste ninguno"), fe("#chooselikes-text").html("concede likes de bonificación");
                ...
                fe("#chooselie-text").html("¿Cuál es el título real?");
    ...
    submitLie() {
        ...
        if (t = t.replace(/\s\s+/g, " ").trim(), t.length === 0) {
            ...
            return fe("#drawful-submit-alert").html("¡no puedes dejarlo en blanco!"), e.removeClass("alert-info"), e.addClass("alert-danger"), e.show(), !1
        }
