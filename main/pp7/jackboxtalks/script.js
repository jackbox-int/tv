...
`,
    ...
    <div class="canvas-container">
        ...
        <div id="post-sketchpad" class="post-sketchpad">
            <div id="submit">
                <button id='submitdrawing' class="button submitDrawing">Enviar</button><br/>
            </div>
    ...
    Qx = Vn.extend({
        ...
        sendInput(t) {
            if (this.sketchpadComponent.getLines().length === 0) {
                Ot.show(Error("¡Tienes que dibujar algo!"));
                return
            }
...
<div class="cameraControls">
    <button id="exitButton" class="button exitButton" aria-label="Salir"></button>
    <div class="buttons pre">
        <button id="switchButton" class="button switchButton" aria-label="Cambiar de cámara"></button>
        <button id="snapshotButton" class="button snapshotButton" aria-label="Tomar foto"></button>
    </div>
    <div class="buttons post">
        <button id="cancelButton" class="button cancelButton" aria-label="Cancel"></button>
        <button id="confirmButton" class="button confirmButton" aria-label="Confirm">MANTENERLA</button>
    </div>
</div>
<div style="display:none;">
    ...
    <div id="slides">
        ...
        <div class="add">
            <button>AGREGAR DIAPOSITIVA</button>
        </div>
    </div>    
</div>
