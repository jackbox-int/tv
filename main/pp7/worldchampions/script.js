...
Ct.View.extend({
    ...
    showTwitchBroadcasterDialog(t) {
        ...
        e += "<div class='success'>Has conectado correctamente tu cuenta a la Extensión de Twitch del Kit de Público de Jackbox.</div>", this.lacksAudience ? e += "<div class='warning'>ESTE JUEGO NO TIENE FUNCIÓN DE PÚBLICO</div>" : this.client.roomInfo.audienceEnabled || (e += "<div class='warning'>ESTA SALA NO TIENE LA OPCIÓN DE PÚBLICO HABILITADA</div>"), _t.show("custom", {
            html: e,
            position: "bottom",
            timer: t,
...
const Bx = Ct.View.extend({
    ...
    showTwitchBroadcasterDialog(t) {
        ...
        e += `
            ...
            </div>`, this.lacksAudience ? e += "<div class='warning'>ESTE JUEGO NO TIENE FUNCIÓN DE PÚBLICO</div>" : this.client.roomInfo.audienceEnabled || (e += "<div class='warning'>ESTA SALA NO TIENE LA OPCIÓN DE PÚBLICO HABILITADA</div>"), _t.show("custom", {
            html: e,
            position: "bottom",
            timer: t,
            backdrop: "transparent",
...
const zx = Ct.View.extend({
    ...
    Hx = In.extend({
        defaults: He.extend({}, jn.prototype.model.defaults, {
            ...
            strings: He.extend({}, jn.prototype.model.defaults.strings, {
                name_modal_text: "Nombra tu campeón:",
                name_modal_confirm: "OK",
                name_modal_cancel: "Cancelar",
                name_error_empty: "¡Tienes que escribir algo!",
                ERROR_REJECTED_OBJECT: "Eso no está permitido, ¡ingresa otra cosa!",
                ERROR_REJECTED_TEXT: "Eso no está permitido, ¡ingresa otra cosa!"
            })
        })
    }),
    Gx = Xs.extend({
    ...
    qx = jn.extend({
        ...
        nameCharacter() {
            ...
            Yt.close(), Yt.fire({
                ...
                cancelButtonText: this.model.get("strings").name_modal_cancel || "Cancelar",
    ...
    Xx = In.extend({
        defaults: {
            ...
            announcePrompt: !1,
            strings: {
                survey_finished: "Gracias por tu aporte. ¡Cumpliste con tu deber cívico!"
            }
        }
    }),
    Kx = Ct.View.extend({
