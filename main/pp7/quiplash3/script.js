    ...
    <div class="form-group">
        ...
        <div class="inputGroup">
            ...
            <span class="inlineSubmit">
                <button type="submit" class="btn btn-default inlineSubmitButton" type="button"><span class="inlineSubmitText">Enviar</span></button>
            </span>
...
`), this.triggerMethod("client:message", e)) : this.client.send("SendMessageToRoomOwner", e), this.$el.find(".enterTextListFieldset").prop("disabled", !1), !1
    ...
    Ex = Rn.extend({
        defaults: {
            toggled: !1,
            leftLabel: "Enunciado normal",
            rightLabel: "Enunciado de Thriplash"
        }
    }),
    _x = yt.View.extend({
        tagName: "div",
