...
const Fx = Ct.View.extend({
    ...
    <li class="pull-left button-pad">\r
        <div class="undoButton">\r
            <button id="undoButton" class="undo button block">Deshacer</button>\r
        </div>\r
    </li>\r
    <li class="pull-right button-pad"> \r
...
`,
    Wx = Hn.extend({
        defaults: Ke.extend({}, ro.prototype.model.defaults, {
            strings: {
                wait: "<div>¡POR FAVOR ESPERA!</div><div>¡El seminario comenzará en breve!</div>",
                vip_waiting: "<div>¡Eres el VIP!</div><div>¡Esperando a que todos los participantes tomen asiento!<div>",
                vip_canStart: "<div>¡Eres el VIP!</div><div>Pulsa este botón cuando todos los participantes estén listos.</div>",
                vip_cancel: "<div>¡Eres el VIP!</div><div>pulsa este botón para cancelar el seminario</div>",
                vip_postgame: "<div>¡Eres el VIP!</div><div>¿Quieres asistir a otro seminario?<div>",
                vip_episodes_menu: "Menú de episodios",
                vip_episodes_unload: "Retirar episodio",
                vip_episodes_report: "Reportar episodio",
                vip_episodes_view_author: "Ver autor",
