...
const $x = Et.View.extend({
    ...
    zx = no.extend({
        ...
        update() {
            this.strings = this.model.get("strings"), this.model.get("gameCanContinue") ? (this.strings.button_sameplayers = "Siguente asalto", this.strings.button_newplayers = "Salir") : (this.strings.button_sameplayers = "Mismos jugadores", this.strings.button_newplayers = "Nuevos jugadores"), no.prototype.update.apply(this)
        }
    });
const Hx = La.extend({
