...
const zx = Px.extend({
    ...
    parseBlob(t) {
        ...
        } else t.state === "MakeSingleChoice" && (t.choiceType && t.choiceType === "PlayerVote" && t.classes.push("playerVote"), t.type === "repeating" ? (t.classes.push("actionChoice"), t.maxVotes = this.client.isRole("player") ? 200 : 100) : t.classes.includes("actionChoice") && (t.type = "repeating", t.maxVotes = this.client.isRole("player") ? 200 : 100), t.prompt.text === "Tap if you think this rhyme is DOPE" && (t.prompt.text = "Toca si crees que esta rima tiene FLOW", t.type = "repeating", t.maxVotes = this.client.isRole("player") ? 200 : 100));
